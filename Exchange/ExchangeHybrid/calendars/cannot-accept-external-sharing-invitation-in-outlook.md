...
> - Calendars that are shared cross-premises are now supported only in Outlook for Windows. If you try to view a cross-premises shared calendar by using any other Outlook application, you cannot sync or view events on the calendar.
