...
1. Remove all delegates from the **Delegates** dialog box in Outlook.
    ...
    :::image type="content" source="media/ndr-5-2-0-when-sending-meeting-invites/remove-delegates.png" alt-text="A screenshot of the dialog to remove delegates" border="false":::
...
2. Sign in to the mailbox through Outlook Web App (OWA), and then confirm  that all delegates are removed. Follow these steps to check delegates in OWA:
   ...
   3. Select **Share** from the menu at the top.
      ...
      :::image type="content" source="media/ndr-5-2-0-when-sending-meeting-invites/share-button.jpg" alt-text="A screenshot of the Share button on the Outlook page" border="false":::

   4. Select the trash can icon to remove any delegates.

      :::image type="content" source="media/ndr-5-2-0-when-sending-meeting-invites/dumpster-icon.jpg" alt-text="A screenshot of the dumpster icon on the Share this calendar page" border="false":::
...
3. Remove any auto-complete entries for the delegates. To do this, follow these steps:
   ...
   2. Type the delegate's name.
      ...
      :::image type="content" source="media/ndr-5-2-0-when-sending-meeting-invites/type-delegate-name.png" alt-text="A screenshot of removing any auto-complete entries page" border="false":::
...
4. Force the Offline Address Book (OAB) to download. This should happen automatically every 24 hours, but it's important to have the most recent version to make sure that the correct delegate information is stored in the manager's mailbox.
   ...
   2. Select **OK**.
      ...
      :::image type="content" source="media/ndr-5-2-0-when-sending-meeting-invites/offline-address-book.png" alt-text="A screenshot of the OK page" border="false":::
