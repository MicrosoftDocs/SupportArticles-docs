...
```powershell
New-RemoteDomaincontoso.com -DomainNamecontoso.comSet-RemoteDomain "contoso.com" -TNEFEnabled $true -AllowedOOFType "InternalLegacy"
```
