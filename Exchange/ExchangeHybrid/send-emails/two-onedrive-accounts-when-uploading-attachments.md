...
After you make these settings, create a new Outlook profile to use the updated values that are set for `OwaMailboxPolicy`. This is necessary because the previous `OwaMailboxPolicy` settings are cached in your current Outlook profile, and they can't be updated.
