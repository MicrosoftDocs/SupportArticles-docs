...
Run the following PowerShell cmdlet to verify that version 3.1.0 of the Exchange Online PowerShell V3 module is installed:
...
3. Try again to run the `Connect-IPPSSession` PowerShell cmdlet to connect to Security & Compliance PowerShell.
