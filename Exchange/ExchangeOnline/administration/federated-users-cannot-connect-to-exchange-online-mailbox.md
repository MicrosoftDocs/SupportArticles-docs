...
For more information about how to troubleshoot AD FS 2.0 proxy server issues, see [How to troubleshoot AD FS endpoint connection issues when users sign in to Microsoft 365, Intune, or Azure](/office365/troubleshoot/active-directory/ad-fs-endpoint-connection-issue).
