...
description: Describes a scenario in which Microsoft 365 users who connect to Exchange Online by using incorrect hardcoded service settings can't connect to the service after July8, 2015 when these settings are discontinued. Provides a solution.
author: cloud-writer
ms.author: meerak
...
The services for which users may be using incorrect settings include:
...
If users continue to use the outdated, hardcoded service settings, they can't connect to the service after July 8, 2015. Use the information that's provided in this article to make sure that these settings are set correctly for users in your organization.
