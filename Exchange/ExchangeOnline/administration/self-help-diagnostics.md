...
|Recipient failure or inconsistency check|Check the state of an Exchange Online recipient and solve common issues.|[Run Tests: EXO Recipient Object Failures](https://aka.ms/PillarEXORecipients)|[Delays in provisioning of user/mailbox or synchronizing changes in Exchange Online](/exchange/troubleshoot/user-and-shared-mailboxes/delays-provision-mailbox-sync-changes)|
