...
|Exchange Organization Object check|Check health and resolve issues related to your Exchange Online organization object. For example, Exchange Online tenant provisioning issues, or RBAC-related issues (various commands aren't available even though users have permissions).|[Run Tests: Exchange organization object](https://aka.ms/PillarEXOOrgCheck)||
