...
| Mailbox safe/blocked sender list diagnostics | Check and identify issues with mailbox safe and blocked sender and domain lists (mailbox junk email configuration). | [Run Tests: Mailbox Safe Blocked Sender List](https://aka.ms/safeblockdiag)| [Configure junk email settings on Exchange Online mailboxes](/defender-office-365/configure-junk-email-settings-on-exo-mailboxes)|
