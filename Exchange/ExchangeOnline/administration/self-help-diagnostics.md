...
|Exchange Organization Object check|Check the health and resolve issues related to your Exchange Online organization object. An example of those issues would be Exchange Online tenant provisioning or RBAC-related issues (various commands not being available even if users have the permissions).|[Run Tests: Exchange organization object](https://aka.ms/PillarEXOOrgCheck)||
