...
- Apply the role assignment policy to all users by using remote PowerShell
  ...
  1. Connect to Exchange Online by using remote PowerShell. For more information about how to do this, see [Connect to Exchange Online using remote PowerShell](http://technet.microsoft.com/library/jj984289%28v=exchg.150%29.aspx).   
