...
1. There are two ways you can find a user's account information:
   ...
   - In the [admin center](https://go.microsoft.com/fwlink/p/?linkid=2024339), type the user's name into the **search** field at the top of the page, and then select them from the list. It will open the user card.

   - Or, in the admin center, go to the **Users** > [Active users](https://go.microsoft.com/fwlink/p/?linkid=834822) page and select the user from the list.
