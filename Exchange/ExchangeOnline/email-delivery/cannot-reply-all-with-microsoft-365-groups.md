...
Consider the following example. You are a member of a Microsoft 365 group and you receive an email message addressed to the group. Using Outlook on the web or new Outlook, you attempt to reply all to the message. You receive an error message similar to the following from Exchange Online.
...
Where "Re: test at 7:43" is the subject of your message.

Also, if you select **More details**, you receive more information that might be confusing.
