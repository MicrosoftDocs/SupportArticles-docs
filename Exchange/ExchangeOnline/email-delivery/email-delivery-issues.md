...
Select the following button to launch the diagnostic in the Microsoft 365 admin center. Enter the email address of the sender, the recipient and other relevant information, and then select **Run Tests**.
