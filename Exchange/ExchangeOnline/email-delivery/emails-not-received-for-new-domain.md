...
When you add a new domain in Office 365 portal, and you create users or change existing users to use the new domain, email messages aren't received for the new domain.
...
2. Make sure that the MX record for the new domain points to the value that's listed in the **DNS Settings** section of the Office 365 portal for Exchange Online. For more information, see [Work with domain names and DNS records in Azure AD](/previous-versions/azure/jj151817(v=azure.100)).
...
- Set up forwarding to the Office 365 users' Online Email Routing Address (`domain.onmicrosoft.com`). For more information, see [Forward email to another email account](https://support.microsoft.com/office/create-reply-to-or-forward-email-messages-in-outlook-on-the-web-ecafbc06-e812-4b9e-a7af-5074a9c7abd0).
