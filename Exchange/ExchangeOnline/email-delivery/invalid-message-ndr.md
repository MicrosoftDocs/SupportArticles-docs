---
title: 554 5.6.0 Invalid message content in Microsoft 365
...
ms.date: 3/31/2022
---
# (554 5.6.0 Invalid message content) NDR when a Microsoft 365 user sends a message that contains an Excel or Word attachment
