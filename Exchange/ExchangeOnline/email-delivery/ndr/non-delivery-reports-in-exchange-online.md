...
|450&nbsp;4.4.317|`Cannot connect to remote server [Message=UntrustedRoot]`|During the TLS handshake, Exchange Online can't validate the authenticity of a leaf certificate that's sent without the full certificate chain by a remote email server.|For more information, see [Fix NDR error code 450 4.4.317 "Cannot connect to remote server [Message=UntrustedRoot]"](/exchange/troubleshoot/email-delivery/ndr/fix-error-code-450-4-4-317-untrusted-root).|
...
|5.1.90|`Your message can't be sent because you've reached your daily limit for message recipients`|The sender has exceeded the recipient rate limit as described in [Sending limits](/office365/servicedescriptions/exchange-online-service-description/exchange-online-limits#sending-limits).|This could indicate the account has been compromised and is being used to send spam. For more information, see [Responding to a compromised account](/defender-office-365/responding-to-a-compromised-email-account).|
...
|5.7.232|`Your message can't be sent because your trial tenant has exceeded its daily limit for sending email to external recipients (tenant external recipient rate limit)`|The trial tenant has exceeded the [Exchange Online rate limit](https://aka.ms/exolimits#sending-limits) for the maximum number of messages sent to external recipients within a 24-hour period. Consequently, any additional messages to external recipients will be blocked until the count for the most recent 24-hour period falls below the limit.|The external recipient rate limit is tracked over a 24-hour rolling window. When the count for the most recent 24-hour period falls below the limit, users in the trial tenant can resume sending messages to external recipients.|
|5.7.233|`Your message can't be sent because your tenant has exceeded its daily limit for sending email to external recipients (tenant external recipient rate limit)`|The tenant has exceeded the [Exchange Online rate limit](https://aka.ms/exolimits#sending-limits) for the maximum number of messages sent to external recipients within a 24-hour period. Consequently, any additional messages to external recipients will be blocked until the count for the most recent 24-hour period falls below the limit.|The external recipient rate limit is tracked over a 24-hour rolling window. When the count for the most recent 24-hour period falls below the limit, users in the tenant can resume sending messages to external recipients.|
