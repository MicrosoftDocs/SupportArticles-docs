...
1. If you route mail from your on-premises environment to Office 365 through an SMTP relay (for example, on-premises mailboxes, multifunction devices, or email sending applications), verify the following settings:
   ...
   - If you use Exchange in your on-premises environment, verify that the smart host value in the Send connector that routes mail to Office 365 does **not** use *mail.messaging.microsoft.com*, *mail.global.frontbridge.com*, or a Microsoft 365 IP address.
