...
Consider the following example. You're a member of a Microsoft 365 group. You receive an email message addressed to the group. Using Outlook on the web or new Outlook, you select **Reply All** and then send the message. You receive an error that states that Exchange Online "Couldn't send this message."
