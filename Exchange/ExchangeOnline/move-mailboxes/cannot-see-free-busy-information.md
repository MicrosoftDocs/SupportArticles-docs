...
![Screenshot of the Scheduling Assistant page](./media/cannot-see-free-busy-information/scheduling-assistant.png)

Also, the user can no longer view the Calendar folder, and the user receives a "Could not be updated" error.

![Screenshot of the Calendar folder](./media/cannot-see-free-busy-information/calendar-folder.png) 
...
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page.png)
 
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page-2.png) 
...
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page-3.png)

Remote users can see the free/busy data in Scheduling Assistant:

![Screenshot of the Scheduling Assistant page](./media/cannot-see-free-busy-information/scheduling-assistant-2.png)

Or, remote users can see the free/busy data as an additional calendar:

![A screenshot of the calendar folder page](./media/cannot-see-free-busy-information/calendar-folder-page.png)
...
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page-4.png)
...
![Screenshot of the Calendar folder](./media/cannot-see-free-busy-information/calendar-folder-2.png) 
...
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page-5.png)
...
![Screenshot of the Calendar Properties page](./media/cannot-see-free-busy-information/calendar-properties-page-6.png)
