...
This issue occurs because the app password is not set for the Google Workspace mailbox. In this scenario, Microsoft 365 migration service can't access the Google Workspace mailbox.
