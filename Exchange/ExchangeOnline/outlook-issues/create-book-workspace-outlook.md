...
5. Save the workspace booking, and then you will receive an autogenerated email about the booking:

    :::image type="content" source="media/create-book-workspace-outlook/workspace-booking-confirmation.png" alt-text="An autogenerated email about the booking.":::
