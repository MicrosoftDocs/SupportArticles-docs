...
description: Describes an issue in which you receive a You may have already signed in to Outlook Web App error message when you try to open Outlook Web App in Microsoft 365. Provides a workaround.
author: simonxjx
ms.author: v-six
...
ms.date: 3/31/2022
---
# You may have already signed in to Outlook Web App error when you try to open Outlook Web App in Microsoft 365

_Original KB number:_ &nbsp; 2798988

## Symptoms

When you try to open Outlook Web App in Microsoft 365, you receive the following error message:
...
- The Microsoft 365 Outlook Web App session and the Outlook.com-based Outlook Web App session share the same Outlook Web App server endpoint.
