---
title: PublicFolderSizeExceedsTargetQuotaException with the migration of public folders
...
This issue occurs for one of the following reasons. You can resolve this issue depending on the cause respectively:
