...
5. Select **New** (:::image type="icon" source="media/senders-not-receiving-out-of-office-notifications/plus-sign-icon.jpg" border="false":::), and then select **Create a new rule for arriving messages**.
