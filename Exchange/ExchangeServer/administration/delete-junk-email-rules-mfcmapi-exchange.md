...
5. Use the MFCMAPI tool to delete the junk email rule. To do this, follow these steps:
    ...
    9. In the bottom pane, sort by the **Tag** column and locate **0x65EB001F**. This tag corresponds to the **JunkEmailRule** value. (The screenshot for this step is listed below).
    ...
    10. After you locate the junk email rule by locating the **0x65EB001F** tag, click to select **IPM.ExtendedRule.Message** again in the top pane.
