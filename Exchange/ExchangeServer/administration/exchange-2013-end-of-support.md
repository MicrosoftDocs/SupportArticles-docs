...
description: Support for Exchange 2013 ended in April 2023. Use this planning roadmap to prepare to upgrade to Exchange Online or a later version of Exchange Server.
ms.author: serdars
...
- Bug fixes for issues that might impact the stability and usability of the server.
...
Migrating to Microsoft 365 is the best and simplest option to help you retire your Exchange 2013 deployment. With a migration to Microsoft 365, you make a single hop away from old technology, and benefit from new features such as these:
...
Depending on your organization, you have a few options to get to Microsoft 365. First, you need to consider a few things, such as factors:
...
The following table describes important things to know about upgrading from Exchange 2013.
