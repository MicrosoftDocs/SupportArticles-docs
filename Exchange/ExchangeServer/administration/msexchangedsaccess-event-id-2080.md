...
AD Access, an Active Directory Service Access component, generates a topology detection event, Event 2080, in the Exchange Server application log. This article describes the contents of the log entry for the event and then describes how to use the contents to troubleshoot DSAccess issues.
...
- **Roles:** The second column shows whether the server can be used as one of the following for this Exchange server:
...
- **System version:** The 11th column indicates whether the operating system of the listed domain controller satisfies the operating system requirements of Exchange Server for use by DSAccess.
