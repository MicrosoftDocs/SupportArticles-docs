...
- The version of Exchange Server that you’re running uses TLS 1.1 or 1.
- The version of Windows Server that's hosting the on-premises Exchange Server is version 2008 or earlier versions, and is using TLS 1.1 or 1.
...
Use the following guidance to enable TLS 1.2 for the instances of Exchange Server and Windows Server in your environment.
