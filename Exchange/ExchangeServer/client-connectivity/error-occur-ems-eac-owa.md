...
- Exchange Server
- CSSTroubleshoot
ms.reviewer: batre, austinmc, exchblt
appliesto:
...
![Output of gpresult cmdlet ](./media/error-occur-ems-eac-owa/output-gpresult-cmdlet.png)
...
![Output of gpresult cmdlet when groups are nested ](./media/error-occur-ems-eac-owa/output-gpresult-cmdlet-when-groups-nested.png)
