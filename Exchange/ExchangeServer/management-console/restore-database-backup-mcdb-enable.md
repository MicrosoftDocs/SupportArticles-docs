...
For detailed steps on how to recover a database see [Restore data using a recovery database](https://docs.microsoft.com/en-us/exchange/restore-data-using-a-recovery-database-exchange-2013-help#use-the-shell-to-recover-data-using-a-recovery-database)
