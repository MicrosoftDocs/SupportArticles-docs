...
When you use a company app to sign in to or authenticate to one of the Microsoft Cloud Services, such as Microsoft 365, Microsoft Intune, Microsoft Dynamics, Microsoft Power BI, or Microsoft Azure, or Azure Active Directory (Azure AD) Federated Gallery Apps, you receive the following error message:
...
- [Microsoft 365: Manually register your app with Azure AD so that it can access Microsoft 365 APIs](/graph/auth-register-app-v2)       
