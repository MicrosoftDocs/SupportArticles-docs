...
### You use your domain in Live@edu
 The domain can exist only in one service. If you use the domain in Live@edu and you want to use the domain in Office 365, remove the domain from Live@edu. 
...
To check whether your Office 365 account has an Exchange federation trust set up 

If you previously verified your domain in your Office 365 account or in another Office 365 account, use Windows PowerShell in Exchange Online to check whether the domain is set up for an Exchange federation trust. To do this, run the following Windows PowerShell cmdlet from Exchange Online PowerShell:
...
[2515404](https://support.microsoft.com/help/2515404) Troubleshoot domain verification issues in Office 365
