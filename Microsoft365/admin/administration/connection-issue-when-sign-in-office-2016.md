...
- The Windows build should be later than 15000 (Windows 10, version 1703, build 15063.138, Generally Available). For more information, see[Windows 10 release information](https://technet.microsoft.com/windows/release-info.aspx).    
