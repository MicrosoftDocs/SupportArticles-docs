...
| Domain already exists. The domain is already associated with your account.|The domain already exists within the Office 365 subscription.|To resolve this issue, see [An administrator cannot add a domain to a Microsoft 365 account](https://support.microsoft.com/help/2279117). |
