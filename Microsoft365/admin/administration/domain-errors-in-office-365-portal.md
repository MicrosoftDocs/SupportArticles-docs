...
|---|---|---|
| Number of unverified domains exceeded. Your account has too many unverified domains. Verify or delete one of your unverified domains, and then add the new domain.|The maximum number of 100 unverified domains is reached.|To resolve this issue, see [An administrator can't add a domain to a Microsoft 365 account](https://support.microsoft.com/help/2279117).   |
| Domain already exists. The domain is already associated with your account.|The domain already exists within the Microsoft 365 subscription.|To resolve this issue, see [An administrator can't add a domain to a Microsoft 365 account](https://support.microsoft.com/help/2279117). |
