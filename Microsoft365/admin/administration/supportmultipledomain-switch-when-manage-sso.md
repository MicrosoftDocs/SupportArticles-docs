...
The rules above may not apply to all scenarios, but can be customized to ensure that the "Issuerid" value matches "FederationServiceIdentifier" for the domain added/federated at Microsoft 365 end.
