...
To fix this issue, use PowerShell to reinstall the WAM packages (for organizational or work accounts) and Live ID (for personal accounts such as @outlook.com, @hotmail.com, and so on). To do this, follow these steps:
...
3. If your issue is about a work account, you have to fix the AAD package. Run the following command in the command console:
