...
For more information about the Autoruns utility that is used to collect this information, see [Autoruns for Windows v13.96](https://docs.microsoft.com/sysinternals/downloads/autoruns).
...
|Description|File name|Formats|
|---|---|---|
|Summary of files found in the folder and subfolders: C:\Users\{username}\AppData\Roaming\Microsoft\Excel|<**ComputerName**>_dir_Contents_AppData-Microsoft-Excel.*|.txt|
