---
title: Error code 6031 when buying licenses in Office 365 portal
description: Fixes an issue in which you receive an error that we can't process your request when you try to buy licenses in the Office 365 portal.
author: simonxjx
...
When you try to buy licenses in the Office 365 portal, you receive the following error message:
...
1. Sign in to the [Office 365 portal](https://www.office.com) or the [Microsoft Intune account portal](https://go.microsoft.com/fwlink/?linkid=2090973) as a Billing or Global administrator.
