...
Follow one of the options to reset your password depending on your privileges to the service that you're trying to sign in to.

If you don't have administrator privileges:

- Ask your administrator to reset your password.
- If your administrator has turned on the capability for you to reset your own password, use the Self-Service Password Reset wizard.
...
- You can use the Self-Service Password Reset wizard to contact Support if the self-service password reset fails. You may need to wait for a few seconds before the link to contact Support displays.
...
- If you're the only administrator on your Azure subscription and have forgotten the password, contact [Azure support](https://azure.microsoft.com/support/create-ticket/).  
