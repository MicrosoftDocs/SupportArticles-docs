...
2. Click **Permission**, click **admin role**, and then click **New** (:::image type="icon" source="media/issue-search-audit-log/add-button.png":::) to create a new role group.
3. On the 'New role group' page, do the following:
   1. Specify a name for the role group.
   1. In the **Role** box, click **Add** (:::image type="icon" source="media/issue-search-audit-log/add-button.png":::), add the **View-Only Audit Log** or **Audit Log** role, and then click **OK**.
   1. In the **Member** box, click **Add** (:::image type="icon" source="media/issue-search-audit-log/add-button.png":::), add the user, and then click **Save**.
