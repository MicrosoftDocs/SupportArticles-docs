...
![Select Edit Policy or Edit to edit a DLP policy](./media/troubleshooting-data-loss-prevention-policy-tips/1.png)
...
![Turn on User notifications](./media/troubleshooting-data-loss-prevention-policy-tips/2.png)

Policy status

![The Show policy tips while in test mode option is not checked](./media/troubleshooting-data-loss-prevention-policy-tips/3.png)
...
![Multiple rules are configured to have same detecting parameters](./media/troubleshooting-data-loss-prevention-policy-tips/4.png)
...
![Policy configurations are not supported](./media/troubleshooting-data-loss-prevention-policy-tips/5.png)
...
![An external sharing condition is configured in a policy](./media/troubleshooting-data-loss-prevention-policy-tips/6.png)
...
![Using MailTips Options to select settings](./media/troubleshooting-data-loss-prevention-policy-tips/7.png)
...
![Set notify a policy in Exchange admin center rule with the Action](./media/troubleshooting-data-loss-prevention-policy-tips/8.png)
...
![Remove the Notify the sender with a Policy Tip action](./media/troubleshooting-data-loss-prevention-policy-tips/9.png)
...
1. Select the policy that requires editing, and then select the pencil icon or double-click the policy that has to be changed.
   ...
   ![Selecting the policy and then the pencil icon in Exchange admin center](./media/troubleshooting-data-loss-prevention-policy-tips/10.png)
...
1. In the window that opens, select the rule, and then select the pencil icon or double-click the rule that has to be changed.
   ...
   ![Select pencil icon in rules section](./media/troubleshooting-data-loss-prevention-policy-tips/11.png)

1. In the next window that opens, you can edit the rule.

   ![Detailed fields to edit](./media/troubleshooting-data-loss-prevention-policy-tips/12.png)
...
![Invalid Instance count and Match accuracy values](./media/troubleshooting-data-loss-prevention-policy-tips/13.png)
