...
|Sensitive data threshold for the DLP policy isn't met. Therefore, the associated DLP policy tips aren't displayed.|Modify the conditions of the applicable DLP policy by using the steps in [Manage DLP Policies](https://technet.microsoft.com/library/jj673559.aspx). For example, you may have to adjust the minimum or maximum sensitive item count values or adjust the kind of sensitive data that triggers the policy.|

> [!NOTE]
> Outlook 2013 doesn't support all the sensitive information types that are listed in
 [Sensitive information types inventory](https://technet.microsoft.com/library/jj150541%28v=exchg.150%29.aspx).
