...
2. Use the procedures at [Manually request crawling and reindexing of a site, a library, or a list](/sharepoint/crawl-site-content) to reindex the site.
...
To resolve this issue, retry [downloading the search results](/microsoft-365/compliance/export-search-results#step-2-download-the-search-results), which will restart the eDiscovery Export Tool.
