...
description: This article describes how to start the information protection scanner diagnostic tool to verify whether the scanner deployment is healthy, and then fix detailed errors that are generated by the scanner.
author: MaryQiu1987
ms.author: v-maqiu
