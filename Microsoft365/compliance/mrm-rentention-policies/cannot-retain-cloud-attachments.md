...
|<u>URLs</u>: HTTP references added into the email subject or body, or meeting text body that provides the address of a file that's stored online.<br><br> Example:<br>       |No        |
