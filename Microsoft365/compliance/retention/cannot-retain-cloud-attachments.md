...
|Sharing mechanism  |Is it a cloud attachment?|
|:------------------- |:---------------:|
|Upload a file from a device and store it in a SharePoint or OneDrive location.<br><br> Example:<br> :::image type="content" source="media/cannot-retain-cloud-attachments/upload-file-from-device.png" alt-text="Screenshot of file uploaded from a device and stored in a SharePoint or OneDrive location.":::       | Yes        |
