...
|Outlook is running as elevated but the Assistant's Command Prompt window isn't elevated|Run an offline scan of Outlook|01: An Offline scan was performed because Outlook is either not running or it's runningas elevated. See \<filename\> in *%localappdata%\saralogs\UploadLogs*.|
