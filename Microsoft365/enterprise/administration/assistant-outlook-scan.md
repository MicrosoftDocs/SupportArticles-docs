...
## Script to run the Outlook Scan scenario

To show you how the Enterprise version of the Assistant can be scripted to run the Outlook Scan scenario, we created a sample Windows PowerShell script.
...
2. Launch SaraCmd.exe to run the Outlook Scan scenario with the required switches and parameters
