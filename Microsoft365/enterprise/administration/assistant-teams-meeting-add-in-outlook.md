...
In the full version of the Assistant, the equivalent scenario entry point is *Teams \ The Teams meeting option isn't shown or the Teams Meeting add-in doesn't load in Outlook*.
