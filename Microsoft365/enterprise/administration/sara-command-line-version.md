...
The Enterprise version of Microsoft Support and Recovery Assistant is an enterprise-ready diagnostic tool that you can use to troubleshoot specific client issues with Office, Teams, Outlook and Advance Diagnostics. 
It runs at a command line or through a script such as PowerShell. It's useful when administrators need to run the Assistant on computers in their organization remotely.
