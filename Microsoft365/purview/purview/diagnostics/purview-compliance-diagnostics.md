...
| [Validate Audit configuration](https://aka.ms/PillarAuditConfigDiag)<br> | Validates general Audit Configuration. Checks Audit logs for a user and identifies configuration issues. | Any Microsoft 365 admin role | [Export, configure, and view audit log records](https://learn.microsoft.com/en-us/purview/audit-log-export-records) |
