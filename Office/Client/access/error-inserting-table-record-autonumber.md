...
:::image type="content" source="./media/error-inserting-table-record-autonumber/auto-number-error.png" alt-text="Screenshot of the error message after trying to insert a new record in a table." border="false":::
