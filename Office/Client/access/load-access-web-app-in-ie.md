...
:::image type="content" source="media/load-access-web-app-in-ie/error-message.png" alt-text="Screenshot of the error message after trying to load a Microsoft Access web app in Internet Explorer." border="false":::
