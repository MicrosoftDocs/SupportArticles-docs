...
:::image type="content" source="media/load-access-web-app-in-ie/error-message.png" alt-text="Screenshot of the error message after the app isn't completely loaded." border="false":::
