...
- You are throttled when you use SharePoint Online. For more information about throttling in SharePoint Online, see [Avoid getting throttled or blocked in SharePoint Online](https://docs.microsoft.com/sharepoint/dev/general-development/how-to-avoid-getting-throttled-or-blocked-in-sharepoint-online).    
...
2. On the **Edit** menu, point to **New**, and then click **DWORD Value**.    3. Type **DataFetchTimeout**, and then press **Enter**.     
...
1. Type **DataFetchTimeout**, and then press **Enter**.     
1. Right-click **DataFetchTimeout**, and then click **Modify**.     
1. Select **Decimal** in **Base**, type **90000** in the **Value data** box, and then click **OK**.
