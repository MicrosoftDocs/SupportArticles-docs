...
Now, when you make a change to a record, and then you either move to a different record or close the form, you're prompted to confirm that you want to save the current record. If you click **No**, the record is reset and the operation continues as normal.
