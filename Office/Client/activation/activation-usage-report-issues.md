...
Beginning September 1, 2021, user names in Microsoft 365 usage reports are anonymous by default. For more information, see [Microsoft 365 reports show anonymous user names instead of actual user names](.../microsoft365/miscellaneous/reports-show-anonymous-user-name.md).
