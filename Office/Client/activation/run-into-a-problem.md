...
When you activate Microsoft 365 Apps, you might encounter the following error:
...
1. From **Start**, right-click on a Microsoft 365 app, and then select **Run as administrator**.
1. If you're prompted, [activate Microsoft 365 Apps](https://support.microsoft.com/office/activate-office-5bd38f38-db92-448b-a982-ad170b1e187e).

If you don't see a message that Microsoft 365 Apps was activated, try the next troubleshooting method.
<br/><br/>
</details>
...
<details>
<summary><b>Make sure you have the correct version of Office installed</b></summary>
...
1. [Check which Microsoft 365 business product or license](https://support.microsoft.com/office/what-microsoft-365-business-product-or-license-do-i-have-f8ab5e25-bf3f-4a47-b264-174b1ee925fd) you have.
   ...
   If you're signed in by using your Work or School account, and don't have a license assigned, [contact your Microsoft 365 Administrator](https://support.microsoft.com/office/how-do-i-find-my-microsoft-365-admin-59b8e361-dbb6-407f-8ac3-a30889e7b99b) to get a license assigned.
...
1. Select the subscription. Check if the subscription is active. If it isn't, select **Reactivate subscription**.
...
[Change your password](https://support.microsoft.com/account-billing/change-your-work-or-school-account-password-97fced88-e0e7-4d7b-a9d3-936a3dcbd569), then try to activate Microsoft 365 again.
<br/><br/>
</details>
...
1. Expand the **Licenses** section, select the checkboxes for the licenses that you want to assign, then select **Save changes**.

   If the license is already assigned, clear the checkbox, select **Save changes**. Then, select the checkbox for the license again and select **Save changes**.
<br/><br/>
</details>
