...
1. To copy the location of the diagnostics that are collected by MSOAID, select **Copy Path**. The file is usually saved to the *%TEMP%* folder of the administrator account that you use to run MSOAID.
    ...
    :::image type="content" source="media/use-msoaid-tool-for-authentication-issues/copy-path.png" alt-text="Screenshot of the Microsoft Office Authentication/Identity Diagnostic window that lists the filepath to which the collected diagnostics are saved." border="false":::
