...
To resolve this issue, run the "Power View" troubleshooter for the add-in. The Power View add-in troubleshooter may automatically fix the problem described in this article. This troubleshooter fixes many problems.[run now](https://go.microsoft.com/fwlink/?linkid=279892)
