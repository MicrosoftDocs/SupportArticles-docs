...
This selection is pasted as a single rectangle:
...
However, you can't add cell B2 to this nonadjacent selection, because Microsoft Excel can't determine which direction you want the cells to slide. For example, B2 could slide between A1 and A3, C1 and C3, A1 and C1 or A3 and C3. This would result in rectangles of varying shapes and sizes. Because you can't designate how you want the rectangle arranged, Excel returns the error message. In this case, the cell range must be a single selection, or the cells must be copied individually.
