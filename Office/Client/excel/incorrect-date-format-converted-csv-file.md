---
title: Date format that's convert a CSV text file by using VBA isn't correct
...
# Date format isn't correct when you convert a CSV text file in Excel by using a VBA macro
