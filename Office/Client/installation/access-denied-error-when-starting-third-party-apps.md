...
The devices affected by this issue were originally sold with the **RS5** release **17763** of Windows with the pre-installed version of Project Centennial for Office. If a user installs a different version of Office (such as Office 2019, Office 2016, or Office Professional Plus), the new version will de-register the Project Centennial Office package but will not completely remove the package from the machine.
...
Once the permissions have been modified, the only way to correct the issue on the computer is to uninstall and reinstall the Office product to replace the ACLs or by performing an Online Repair to reset the ACLs. See [Repair an Office application](https://support.office.com/Article/Repair-an-Office-application-7821d4b6-7c1d-4205-aa0e-a6b40c5bb88b) for more information. 
