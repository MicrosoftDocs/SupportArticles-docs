...
If the Centennial Office package files are not completely removed from the affected computer, the issue will reoccur when Centennial Office receives an update from the Microsoft Store. 
