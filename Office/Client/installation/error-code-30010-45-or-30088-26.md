...
When you select **Close** on the 30010-45 error message, you'll also encounter the following error:
...
1. Restart the device, and then try installing Microsoft 365 Apps again.
