---
title: Error code 30010-45 or 30088-26 installing Microsoft 365 Apps
description: Provides steps to fix Error code 30010-45 or 30088-26 setup errors.
author: rahulp
...
# Error code 30010-45 or 30088-26 installing Microsoft 365 Apps

## Symptoms

If you try to install Microsoft 365 Apps while using FSLogix to manage profiles, you might encounter one of the following errors:
...
When you choose **Close** on the 30010-45 error message, you will also encounter the following error:
...
> Please try installing again after you've check the above.<br>
...
1. From Start, type *cmd*. Right-click **Command Prompt** in the search results, and then select **Run as administrator**.

1. Type the following command at the command prompt and then press Enter:

    `“C:\Program Files\FSLogix\Apps\frx.exe" list-rules`

1. Check for rules in the list that hide Office executables. Example:
...
1. Restart the device and try installing Microsoft 365 Apps again.