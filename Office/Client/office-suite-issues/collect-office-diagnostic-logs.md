...
1. Open a Command Prompt window. At the command prompt, locate the folder where you extracted the OfficeDiagnosticLogging.bat script.
...
1. Close the windows of all Office applications that experienced the issue. This action forces all log data to be flushed to disk.
