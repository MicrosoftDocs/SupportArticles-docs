...
> [!NOTE]
> Activation is now required for Office 2010 Volume License suites and programs. For further information on Volume License activation in Office, see [Volume activation of Office 2013](/previous-versions/office/office-2013-resource-kit/ee705504(v=office.15)?redirectedfrom=MSDN).
...
Q9: Does the product stop working if I don't activate it?
...
A10: In reduced-functionality mode, programs function similarly to viewers. When a program runs in reduced-functionality mode, many commands are unavailable (dimmed). Therefore, you can't access those functionalities. Some limitations of reduced-functionality mode include:
...
To find the product ID, click **About Program_Name** on the **Help** menu in an Office program. In Access 2007, Excel 2007, PowerPoint 2007, and Word 2007, follow these steps:
...
A12: If you don't activate an Office product, you receive a reminder to activate your product every time that you start the program.

The reminder helps make sure that you're aware that license activation is required and that you can complete the product activation process before the program enters reduced-functionality mode.
...
- [Uninstall Office from a PC](https://support.office.com/article/uninstall-office-from-a-pc-9dd49b83-264a-477a-8fcc-2fdf5dbf61d8#OfficeVersion=Click-to-Run_or_MSI)
