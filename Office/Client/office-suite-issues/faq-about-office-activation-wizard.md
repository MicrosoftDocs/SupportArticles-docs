...
A10: In reduced-functionality mode, programs function similarly to viewers. When a program runs in reduced-functionality mode, many commands are unavailable (dimmed). Therefore, you cannot access those functionalities. Some limitations of reduced-functionality mode include:
