...
1. Open the PowerPoint 97 or PowerPoint 2000 presentation.
2. Click the **Microsoft Office Button** ![ Microsoft Office Button](./media/presentation-file-size-increases/office2007filebutton.png), and then click **PowerPoint Options**.
