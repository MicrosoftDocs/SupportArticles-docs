---
title: Can't add Visio drawing control to Windows Form application
...
# You can't add the Microsoft Visio 2010 or 2013 drawing control to a Windows Form application in Visual Studio if you have the 64-bit version of Visio installed
...
- **Microsoft Office Visio Drawing Control** doesn't appear in the **COM Components** tab in the **Choose Toolbox Items** dialog box as expected. Therefore, you can't add the drawing control to a Windows Form application in Microsoft Visual Studio.   
...
These problems occur because the Visual Studio designer doesn't support 64-bit ActiveX controls and because the 64-bit version of Visio only works with the 64-bit version of the Microsoft Office Visio drawing control. Therefore, the drawing control can't be instantiated. 
...
3. Move the Visual Studio project to a computer that has the 64-bit version of Visio 2010 installed. The drawing control can't be seen in the Windows Form application. This behavior is expected.   
...
5. Use the 64-bit version of the MSBuild.exe tool to build the solution if the AxVisOcx wrapper assembly for the drawing control can't be created by building the solution. To do so, follow these steps:
    ...
    **Notes**
    ...
    - You can safely ignore warnings that are related to setup projects. The MSBuild.exe tool doesn't support setup projects. Therefore, setup projects can't be built.   
