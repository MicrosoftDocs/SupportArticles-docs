...
Some of the shapes that were available only online, such as the geographic map shapes, are available for download in the [Microsoft Download Center](http://www.microsoft.com/downloads/). These shapes can be found by searching for "Visio" in the Microsoft Download Center.
...
Installing the Windows Search service on Windows Server - see the [reference](http://support.microsoft.com/kb/954822) for more details
...
Installing the latest IFilter updates (Visio 2007 and earlier) - refer to the [website](http://www.microsoft.com/download/details.aspx?id=20109) to download the update.
