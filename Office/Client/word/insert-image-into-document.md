---
title: Scan and insert an image into a document
description: Provides steps and screenshots on how to insert a scanned image into a Microsoft Word 2010 document.
author: simonxjx
...
4. Click **Insert**, and then select **Picture**.
   ...
   ![Word 2010 insert picture ](./media/insert-image-into-document/insert-pictures-button.jpg)
5. In the **Insert Picture** box, browse to the folder that contains the saved image.   
6. Select the image and then click **Insert**.

   ![Word 2010 select image ](./media/insert-image-into-document/select-pictures-to-insert.jpg)
