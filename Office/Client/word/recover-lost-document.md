...
1. Use Word to automatically find the auto-recovered files. To do this, follow these steps:
   ...
   :::image type="content" source="media/recover-lost-document/Contextual_Menu_sm.png" alt-text="Select Task Manager." lightbox="media/recover-lost-document/Contextual_Menu.png":::
   ...
   :::image type="content" source="media/recover-lost-document/Task_Mgr_sm.png" alt-text="Select an instance of Word and then select End Task or End Process." lightbox="media/recover-lost-document/Task_Mgr.png":::

   3. Close the **Windows Task Manager** dialog box, and then start Word.

   :::image type="content" source="media/recover-lost-document/Word_sm.png" alt-text="Start Word." lightbox="media/recover-lost-document/Word.png":::
