...
1. Take the Office Web Apps farm offline if there is a load balancer.
1. Collect the current farm information through PowerShell by using the following command on an Office Web Apps (WAC) Server(s):
...
To verify that your Office Web Apps was configured correctly, go to **https://servername/hosting/discovery** in a web browser.
