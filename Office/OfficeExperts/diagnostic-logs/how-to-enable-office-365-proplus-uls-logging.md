...
Reproduce the issue and collect the logs for review. The logs are in the format MachineName-Date-time.log and stored under %temp% for sign-in or activation issues.
...
Reproduce the issue and collect the logs for review. The logs are in the format MachineName-Date-time.log and stored under %windir%\temp and %temp% for installation or patching issues.
