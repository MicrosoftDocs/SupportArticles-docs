...
1. Refer to the following articles to find the GUID in the Office version, as appropriate for your situation:
   ...
   - [Description of the numbering scheme for product code GUIDs in Office 2016](https://docs.microsoft.com/en-us/office/troubleshoot/miscellaneous/numbering-scheme-for-product-guid)
   - [Description of the numbering scheme for product code GUIDs in Office 2013](https://docs.microsoft.com/en-us/office/troubleshoot/miscellaneous/numbering-scheme-product-code-guids)
