...
description: Describes two scenarios in which Outlook prompts for credentials and doesn't use Modern Authentication to connect Office 365. Provides a resolution.
author: helenclu
ms.author: luche
...
Create the following registry key to force Outlook to use the newer authentication method for web services, such as EWS and Autodiscover. It is recommended that users force Outlook to use Modern Authentication.
