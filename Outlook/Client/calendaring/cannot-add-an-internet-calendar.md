...
To work around this issue, use Outlook Web App (OWA). OWA doesn't have this authentication header behavior. Therefore, it opens the Internet calendar that you want to add.
