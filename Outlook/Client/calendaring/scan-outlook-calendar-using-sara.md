...
- **Configuration Summary** - Lists the configuration settings that were analyzed during the scan to identify issues.
    ...
    :::image type="content" source="media/scan-outlook-calendar-using-sara/configuration-summary-tab.png" alt-text="Screenshot of tab for configuration summary." border="false":::
