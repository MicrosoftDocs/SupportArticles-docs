...
![Screenshot of the failed meeting status](./media/specific-users-not-receive-meeting-requests/meeting-status.png)
...
![Screenshot of the error message](./media/specific-users-not-receive-meeting-requests/error-message.png)
...
- Set the delivery option to **My delegates only**, as shown in the following screenshot:
  ...
  ![Screenshot of the delivery option](./media/specific-users-not-receive-meeting-requests/delivery-option.png)
