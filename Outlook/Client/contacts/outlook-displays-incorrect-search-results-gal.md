...
- Method 1
    ...
    1. Click **Start**:::image type="content" source="./media/outlook-displays-incorrect-search-results-gal/vista-start-button.png" alt-text="Screenshot of Start button in Windows Vista." border="false":::, click **Run**, type *Regedit*, and then press **OK**.
