---
title: CDO 1.2.1 isn't supported with Outlook 2010 and later versions
description: Collaboration Data Objects (CDO) 1.2.1 isn't supported with Outlook 2010 and later versions.
...
ms.date: 01/30/2024
---
# Collaboration Data Objects (CDO) 1.2.1 isn't supported with Outlook 2010 and later versions

## Summary

Although the Collaboration Data Objects (CDO) 1.2.1 object library could be used with Microsoft Outlook 2010 and later versions, we don't recommend or support it in any way.
...
Microsoft product support can help developer customers migrate custom programs from using CDO 1.2.1 to using other APIs. However, Microsoft doesn't provide support for any scenarios in which CDO 1.2.1 is used with Outlook 2010 or Outlook 2013.
