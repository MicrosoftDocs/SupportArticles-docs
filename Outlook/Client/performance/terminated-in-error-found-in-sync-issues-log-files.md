...
- Outlook 2019, 2016, 2013, or Outlook for Office 365
  ...
  3. Locate the OST file for your email address, and note the path and filename of the OST file.
      ...
      :::image type="content" source="media/terminated-in-error-found-in-sync-issues-log-files/data-files.png" alt-text="Screenshot of Data Files tab in Account Settings in Outlook." border="false":::
