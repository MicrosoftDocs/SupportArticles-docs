...
- Set the additional mailbox to stop using Cached Exchange Mode. For detailed steps, see [Turn on Cached Exchange Mode](https://support.office.com/article/Turn-on-Cached-Exchange-Mode-7885AF08-9A60-4EC3-850A-E221C1ED0C1C).
