...
:::image type="content" source="media/offline-item-count-for-folder-differs-from-server-count/server-count-and-offline-item-count.png" alt-text="Screenshot of Synchronization tab in Inbox Properties. In this example, Server folder contains 39 items and Offline folder contains 2 items." border="false":::
