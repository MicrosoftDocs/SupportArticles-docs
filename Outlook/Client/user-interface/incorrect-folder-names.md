...
7. Exit Outlook on the web.
    ...
    > [!NOTE]
    > If your preferred language is already selected, select a different language, save the setting, reset the setting to your preferred language, and then save the setting again.
...
1. Sort the entries by the **Tag** column and search for the **0x35FF0102** property tag. Then double-click this property tag.
