...
For module 2.0.3 and later, update the script as follows at line #639:
Import-Module "C:\Program Files\WindowsPowerShell\Modules\ExchangeOnlineManagement\2.0.3\netFramework\Microsoft.IdentityModel.Clients.ActiveDirectory.dll" -force
