...
To add an Exchange Server mailbox in the new Outlook for Mac, see [Add an email account to Outlook for Mac](https://support.microsoft.com/office/add-an-email-account-to-outlook-for-mac-6aeec61b-86af-40af-8ffe-985d0fc82ddb).
