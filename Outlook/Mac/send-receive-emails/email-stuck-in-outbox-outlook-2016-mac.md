...
|---|---|
|![correct Sent and Archive folders in a working account](./media/email-stuck-in-outbox-outlook-2016-mac/correct-folders.png)<br/>|![incorrect Sent and Archive folders in a non-working account](./media/email-stuck-in-outbox-outlook-2016-mac/incorrect-folders.png)<br/>|
|||
