...
> [!NOTE]
> The Outlook Preferences file doesn't contain all the preferences for the application. Also, resetting Outlook preferences doesn't remove email messages or account settings.
