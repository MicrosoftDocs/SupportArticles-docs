...
> - If you configure an incomplete .prf or .msp file in Outlook 2010 or Outlook 2013, this may cause a blank value for the registry key. For more information, see [(KB2923056) 0x8007007A error when you try to download an Offline Address Book because of an incomplete .prf or .msp file](../contacts/0x8007007a-whendownloading-offline-address-book.md).
