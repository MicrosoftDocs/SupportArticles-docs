---
title: Can't import (.olm) files from Outlook for Mac to Outlook for Windows 
...
ms.date: 01/30/2024
---
# Can't import `.olm` files from Outlook for Mac to Outlook for Windows
...
> [!NOTE]
> Currently, Microsoft doesn't have a utility to convert an `.olm` file to a .pst file.
