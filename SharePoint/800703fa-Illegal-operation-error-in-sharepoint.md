...
[A COM+ application may stop working on Windows Server 2008 when the identity user logs off](http://blogs.msdn.com/b/distributedservices/archive/2009/11/06/a-com-server-application-may-stop-working-on-windows-server-2008.aspx)
