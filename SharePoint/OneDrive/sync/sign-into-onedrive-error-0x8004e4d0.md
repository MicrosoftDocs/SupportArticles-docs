...
1. As an administrator, select [OneDrive Site User ID Mismatch](https://aka.ms/PillarOneDriveIDMismatch), and it will populate a help query in the [Microsoft 365 admin center](https://go.microsoft.com/fwlink/p/?linkid=2024339).
