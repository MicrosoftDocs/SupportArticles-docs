...
description: You can't sign to the OneDrive sync app with the error AADSTS50020 because of cached identities from the previous tenant.
author: MaryQiu1987
ms.author: v-maqiu
...
You can't sign in to the Microsoft OneDrive sync app, and receive the following error message:
...
This issue may be caused by cached identities from the previous tenant and most commonly occurs during a tenant-to-tenant migration.
...
To resolve this issue, remove the cached Office account identities from the registry.
