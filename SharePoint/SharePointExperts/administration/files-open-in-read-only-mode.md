...
:::image type="content" source="media/files-open-in-read-only-mode/read-only-document.png" alt-text="Screenshot of read-only document in Microsoft SharePoint Server 2013." border="false":::
