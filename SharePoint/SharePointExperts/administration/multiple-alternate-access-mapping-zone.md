...
:::image type="content" source="media/multiple-alternate-access-mapping-zone/alternate-access-mappings.png" alt-text="Screenshot of Alternate Access Mapping page, which displays the default zone URL that Office Online Server will use to contact the SharePoint Server.":::
