...
## ["This workbook contains external data connections or BI features that are not supported." when you use a guest link to a workbook in Excel Online](./this-workbook-contains-external-data-connections-or-bi-features-that-are-not-supported-when-you-use-a-guest-link-to-a-workbook-in-excel-online.md)
