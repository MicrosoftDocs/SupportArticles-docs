...
![the error message dialog box](./media/this-workbook-contains-external-data-connections-or-bi-features-that-are-not-supported-when-you-use-a-guest-link-to-a-workbook-in-excel-online/error-message.png)
