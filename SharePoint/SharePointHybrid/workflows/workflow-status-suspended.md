...
1. On the Workflow Settings page for the workflow, clear the **Automatically update the workflow status to the current stage name** check box.
   ...
   :::image type="content" source="./media/workflow-status-suspended/workflow.png" alt-text="Screenshot that shows the option to uncheck the automatically update option in Workflow settings page.":::
