...
For more information, see [Preparing for TLS 1.2 in Office 365 and Office 365 GCC](/microsoft-365/compliance/prepare-tls-1.2-in-office-365).<br/>
...
The issue might occur because of the operating system in use and whether the web client supports TLS 1.2. Web Client. Support for TLS 1.2 is as follows:
