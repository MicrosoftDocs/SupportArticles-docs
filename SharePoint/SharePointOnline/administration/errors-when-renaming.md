...
|1089|Max no. of allowed sites exceeded.|During a tenant rename, the maximum number of sites allowed by the standard rename has been exceeded.|For larger organizations, use [Advanced Tenant Rename](/sharepoint/change-your-sharepoint-domain-name#advanced-tenant-rename).|
