...
|1089|Max no. of allowed sites exceeded.|During a tenant rename, the maximum number of sites allowed by the standard rename has been exceeded.|For larger organizations, use https://aka.ms/AdvancedTenantRename.|
