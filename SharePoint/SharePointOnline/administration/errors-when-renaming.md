...
|1089| Max no. of allowed sites exceeded.| During tenant rename the maximum number of sites allowed as per standard rename are exceeded. Support for larger organizations available with Advanced Tenant rename.| Refer [aka.ms/AdvancedTenantRename](https://learn.microsoft.com/en-us/sharepoint/change-your-sharepoint-domain-name#advanced-tenant-rename).|
