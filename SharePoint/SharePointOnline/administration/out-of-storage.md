...
As a Global admin, you might recive an email message that contains one of the following messages:
...
Your organization has a total storage allowance of 1 TB plus 10 GB per license of eligible plan purchased, plus any Microsoft 365 Extra File Storage add-ons that you've purchased. For more information, see  [SharePoint limits](/office365/servicedescriptions/sharepoint-online-service-description/sharepoint-online-limits).

## Resolution

If you suspect that you should have more storage than the amount that's displayed in the Microsoft 365 admin center, Microsoft 365 admins can run the following diagnostic tool. The tool identifies any issues that affect your SharePoint tenant storage quota. It also shows how the quota is allocated.
