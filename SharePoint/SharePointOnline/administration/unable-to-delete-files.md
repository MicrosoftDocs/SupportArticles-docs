...
- Retention labels can cause this. For more information about the restrictions on which actions are allowed or blocked, see this [comparison table](/microsoft-365/compliance/records-management?view=o365-worldwide&preserve-view=true#compare-restrictions-for-what-actions-are-allowed-or-blocked).
