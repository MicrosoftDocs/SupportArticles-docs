...
There are currently diagnostics covering various areas within Sharepoint and OneDrive. Each diagnostic is listed here together with a brief description of its function and also a shortcut link:

| Diagnostic | Description | Shortcut Link | Support Article |
| --- | --- | -- | -- |
| **External sharing** | Diagnose issues with sharing, such as determining why guests are unable to access content. | [Run Tests: External Sharing](https://aka.ms/PillarExternalSharing) |
