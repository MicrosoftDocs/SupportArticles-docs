...
When you try to create documents in the Microsoft Office 365 portal in Microsoft Office 365 Small Business, you receive the following error message:
...
1. Return to the Office 365 portal, and then create a document.
