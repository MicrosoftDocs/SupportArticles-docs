...
A hotfix is available to resolve this issue. For more information, see [Slow performance when you connect to a WebDAV shared folder in Windows 8 or Window Server 2012](https://support.microsoft.com/help/2782826).
