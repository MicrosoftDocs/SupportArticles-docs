...
It's possible that the user’s OneDrive site is in a locked "NoAccess" state. As a global or SharePoint admin in Microsoft 365, you can unlock the site by using PowerShell. For more information, see [Lock and unlock sites](/sharepoint/manage-lock-status).  
</details>
