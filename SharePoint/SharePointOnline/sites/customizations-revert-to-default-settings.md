...
For more information about themes in SharePoint, go to [Overview of themes in SharePoint Server](https://docs.microsoft.com/SharePoint/sites/themes-overview).
