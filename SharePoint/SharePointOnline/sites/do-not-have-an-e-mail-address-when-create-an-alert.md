...
To resolve this issue, configure SharePoint Online to enable users to configure their email address within their My Site profile and configure the changes to replicate to the sites. As a SharePoint administrator, follow these steps:
