...
2. Make sure the O365 group property "HiddenFromAddressListsEnabled" is set to True. Exchange or Global administrators should use [Set-UnifiedGroup](https://docs.microsoft.com/en-us/powershell/module/exchange/users-and-groups/set-unifiedgroup?view=exchange-ps) to set HiddenFromAddressListsEnabled to False.
