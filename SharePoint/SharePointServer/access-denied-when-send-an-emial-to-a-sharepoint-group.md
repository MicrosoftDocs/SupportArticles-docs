...
# Access denied when you send an emial to a SharePoint group by using SharePoint Server 2013 workflows  
...
```  
Retrying last request. Next attempt scheduled in less than one minute. Details of last request: HTTP Unauthorized to http://URL/_vti_bin/client.svc/sp.utilities.utility.SendEmail  
