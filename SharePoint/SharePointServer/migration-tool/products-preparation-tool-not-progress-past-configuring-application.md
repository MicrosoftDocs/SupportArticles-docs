...
- [Microsoft Purview Information Protection and Control Client (MSIPC)](https://www.microsoft.com/download/details.aspx?id=38396) MSIPC.dll - Microsoft Active Directory Rights Management Services Client. See [AD RMS Client 2.0 Deployment Notes](/azure/information-protection/rms-client/client-deployment-notes) for more information.  
