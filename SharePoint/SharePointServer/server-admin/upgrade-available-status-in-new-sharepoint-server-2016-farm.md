...
- In Central Administration, you click on Monitoring . then you click on Review Database Status . The SharePoint_AdminContent_<GUID>  database has the following status: "Database is in compatibility range and upgrade is recommended".  
