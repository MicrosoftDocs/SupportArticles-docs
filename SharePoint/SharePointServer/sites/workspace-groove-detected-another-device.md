...
description: Describe an issue that occurs because the SharePoint Workspace or Groove device URL must be unique for each computer. Provides a resolution.
author: helenclu
...
When this issue occurs, SharePoint Workspace or Groove may start. However, Groove messages and workspace synchronization are unreliable.
...
You can't change the device URL in an active SharePoint Workspace or Groove installation. To work around this issue, you must remove all SharePoint Workspace or Groove data on each affected computer. This data includes the account and all workspaces. Then, each user must create a new account. 

**Note** Don't save your account to a file and then restore it. The device URL is saved in the account file. 
...
The following procedures can help you recover from this issue with as little data loss as possible. 

### For SharePoint Workspace 2010

1. In SharePoint Workspace, view Workspaces in the Launch bar.
...
For more information about how to remove data without uninstalling SharePoint Workspace, select the following article number to view the article in the Microsoft Knowledge Base:

[982279](https://support.microsoft.com/help/982279) How to delete temporary and permanent data in SharePoint Workspace 2010

### For Groove 2007

1. In Groove 2007, view Workspaces in the Launch bar.
2. For each Groove workspace that has other members, make sure that another member has all workspace data.   
3. For each Groove workspace that has no other members, save the workspace as an archive.   
...
For more information about how to uninstall Groove, select the following article number to view the article in the Microsoft Knowledge Base: 

[907504 ](https://support.microsoft.com/help/907504) How to uninstall Groove 

### How to create images

To prevent this issue when you create images, don't start SharePoint Workspace or Groove between the time that you install SharePoint Workspace or Groove and the time that you create an image from the installation.
