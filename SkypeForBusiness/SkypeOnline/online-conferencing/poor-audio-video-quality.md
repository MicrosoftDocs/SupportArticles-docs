...
2. Make sure that the audio/video device that is being used is approved and certified to work with Lync 2010. For more information, see [Phones and devices qualified for Lync](https://technet.microsoft.com/lync/gg278173.aspx). 
