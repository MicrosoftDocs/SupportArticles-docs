...
:::image type="content" source="./media/issue-sign-in-german-environment/sign-in-window.png" alt-text="Screenshot that shows the sign-in window with error message.":::
