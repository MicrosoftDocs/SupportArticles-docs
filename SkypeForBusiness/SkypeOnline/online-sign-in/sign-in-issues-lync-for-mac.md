...
- If you're running Mac OS X 10.5, Mac OS X 10.6, or Mac OS X 10.7 Lion, start Terminal, and then run the `dscacheutil -flushcache` command.
- If you're running Mac OS X 10.4 Tiger, start Terminal, and then run the `lookupd -flushcache` command.
