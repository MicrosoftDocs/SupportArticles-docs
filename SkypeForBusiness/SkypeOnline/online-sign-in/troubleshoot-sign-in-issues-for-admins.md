...
If the users can't sign in to Microsoft 365, ask them to try the troubleshooting steps suggested in [You can't sign in to Microsoft 365, Azure, or Intune](/microsoft-365/troubleshoot/sign-In/sign-in-to-microsoft-365-azure-intune).
