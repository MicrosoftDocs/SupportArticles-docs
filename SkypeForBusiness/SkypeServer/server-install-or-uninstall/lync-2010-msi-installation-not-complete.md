---
title: The installation of Lync 2010 doesn't complete using Windows Installer (MSI)
...
1. Right-click **UseMSIForLyncInstallation**, and then select **Modify**.
1. In the **Value data** box, type 1 if that value isn't already displayed, and then select **OK**.
