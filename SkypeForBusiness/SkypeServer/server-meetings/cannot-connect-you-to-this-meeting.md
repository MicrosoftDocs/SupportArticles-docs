...
description: Discusses a problem in which you receive the 12029 error message and you can't connect to a meeting in Skype for Business 2016 or 2015.
author: simonxjx
...
This problem occurs because Windows 7 isn't configured to support the TLS 1.2 protocol, and the Federated partner disabled support for TLS 1.0 and 1.1 in their on-premises environment.  
...
To resolve this problem, enable TLS 1.2 support on Windows 7. To do so, follow the guidance in the following Knowledge Base article, and then restart the computer.
