---
title: Meeting invitations aren't sent from Outlook in Skype for Business
description: Discusses a problem in which meeting invitations aren't sent from Outlook in Skype for Business. Provides a workaround.
author: simonxjx
...
# Meeting invitations aren't sent from Outlook in Skype for Business
...
To work around this problem, use one of the following methods to clear the Auto-Complete cache.

### Method 1

Change the manner in which the Skype for Business Add-in for Outlook (UCAddin.dll) resolves recipients for meetings. To do so, create the following registry key:
...
3. Clear the **Use Auto-Complete List to suggest names when typing in the To, CC, and Bcc lines** check box. Then, select the **Empty Auto-Complete List** button.
