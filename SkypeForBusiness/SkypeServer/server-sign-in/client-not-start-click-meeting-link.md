...
[May 2015 cumulative update (5.0.8308.887)](https://support.microsoft.com/help/2809243) for Microsoft Lync Server 2013 that enables Mac users and Windows users to join a meeting by using Lync Web App in any default browser that you set. It does not require to use NPAPI to join a meeting if Chrome is the default browser.
