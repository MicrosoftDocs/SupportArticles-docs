...
- Front row requires 1920\*1080 resolution for 16:9 display or 2560*1080 resolution for 21:9 display. These displays are set to 100% scaling. If the chat panel on your front-of-room display shows unreadable UI, see [Change scale and resolution for front-of-room](/microsoftteams/rooms/rooms-operations#change-scale-and-resolution) to adjust your display settings.
