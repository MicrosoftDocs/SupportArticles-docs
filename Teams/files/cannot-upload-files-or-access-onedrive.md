...
[Error 1](#error-message-1) can have multiple causes. To resolve Error 1, try each of the following resolutions in the order in which they're listed. Check whether the issue is resolved after you try each resolution before you go to the next one.

To resolve [Error 2](#error-message-2), try Resolution 2.
...
[Error 2](#error-message-2) can occur if your OneDrive site is set as NoAccess.
