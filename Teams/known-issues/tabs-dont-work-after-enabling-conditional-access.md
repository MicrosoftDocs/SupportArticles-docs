...
The tabs affected are the website tabs and app tabs (such as PowerBI, Forms, VSTS, PowerApps, and SharePoint List) that open an AAD authentication dialog requiring users to sign-in with their AAD credentials.
