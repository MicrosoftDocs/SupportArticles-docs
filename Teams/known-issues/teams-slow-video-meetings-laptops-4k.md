...
- Disable GPU hardware acceleration in Teams. To disable this function, select the **Settings and more** menu next to your profile picture at the top right of Teams, make sure that the **Disable GPU hardware acceleration** option is **checked**.
