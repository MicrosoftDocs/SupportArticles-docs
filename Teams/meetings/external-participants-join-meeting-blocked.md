...
- Turn off [guest access](/microsoftteams/guest-access). To do so, in the [Microsoft Teams admin center](https://admin.teams.microsoft.com/), select __Settings and policies__> **Guest access**, and then set **Allow guest access in Teams** to **Off**. 
