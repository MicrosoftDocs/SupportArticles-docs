...
You may diagnose the issue to see if this is a problem with your account by running the Teams Meeting Recording Test at https://aka.ms/MRCA-TMR. 
This test verifies if your account meets all requirements to record a meeting in Teams, if the issue persists please continue to follow the information below.
