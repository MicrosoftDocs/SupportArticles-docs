...
If you're unable to use Apple CarPlay with Teams, your administrator must configure the following settings by using the [Microsoft Endpoint Manager admin center](https://endpoint.microsoft.com/).

### Allow your device to use Siri

The default setting for using Siri should allow you to use CarPlay. If your admin has created a configuration profile to manage your device that blocks Siri, the setting must be updated.
...
If your admin has created an application protection policy that allows data transfer only to specific apps, that restriction must be removed to allow data transfer to all apps.
