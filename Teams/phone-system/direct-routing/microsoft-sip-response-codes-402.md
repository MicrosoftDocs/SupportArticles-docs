...
This article provides troubleshooting information for combination of the SIP 402 error and Microsoft response code 560402.
...
- SIP response code: **402**
- Suggested actions:  
  - Review the tenant's call records that include *CallEndSubReason = 560402*. Look for trends in the called numbers, or a distribution of the failures by destination country/region. Patterns can be identified that would suggest a problem with a downstream PSTN carrier.
