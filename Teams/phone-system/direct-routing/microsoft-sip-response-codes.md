...
- For all other Microsoft response codes that do not start with *560*, the final SIP response code is generated by Microsoft service.

For more information about the most common errors and suggested actions on how to further troubleshoot and mitigate the issue, select a SIP response code from the following list:
