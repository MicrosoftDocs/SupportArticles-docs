...
|Checks whether a user account meets the requirements for a Microsoft Teams user to be able to sign in to a Teams Android desk phone.||[Teams Android Desk Phone Sign in](https://testconnectivity.microsoft.com/tests/TeamsAndroidDeskPhone/input)|[Signed out of Teams on Android devices](../teams-rooms-and-devices/signed-out-of-teams-android-devices.md)|
