...
To prevent this behavior, make sure that your system supports hardware acceleration. To verify the same, you can browse `chrome://gpu/` in Google Chrome. If you can see any value in it stating "Software only" or "hardware acceleration unavailable" that means the system does not support it. For more help, we recommend you contact your hardware provider.
