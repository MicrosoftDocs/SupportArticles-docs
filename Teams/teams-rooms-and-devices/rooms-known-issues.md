...
| Microsoft Teams Rooms on Windows does not display video from Jabra Panacast 50 | When the **Whiteboard sharing mode** in Jabra Panacast 50 is set to **In separate content camera view**, Teams Rooms on Windows is unable to display video. | The fix for this issue is available in application version [4.12.138.0](/microsoftteams/rooms/rooms-release-note#4121380-5262022) |
