...
| No video for remote participants from Android Meeting Room devices | Remote participants can't get video from meeting participants who're using Teams Rooms on Android devices, such as MTRA Poly X50, X30, and Yealink A20. The issue is intermittent. | The new Teams Rooms on Android update (1449/1.0.96.2022051102) addresses most common root causes of no-video issues. It is available through Teams Admin Center for select devices now and will be available to all devices in the first half of June. We will continue improving video performance and reliability in the following releases. |
