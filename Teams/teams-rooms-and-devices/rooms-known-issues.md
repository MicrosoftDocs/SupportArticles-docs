...
| The busy on busy feature is unavailable | The busy on busy feature is not available on Teams Phones. | There is no workaround; the feature is not yet available on Teams Phones. |
| Unresponsive device/device doesn't show up in Teams Admin Center | Database is throttling a Microsoft Teams Room device or the device does not show up in the Teams Admin Center. | There is no workaround for this bug currently. |
