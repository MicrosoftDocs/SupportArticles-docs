...
| Black screen replaces meeting video in Zoom calls | In a Zoom meeting on a device that's running the Teams Rooms for Windows app, the video feed from the device appears as a black screen both on the device and for the remote participants in the meeting. | No workaround is available at this time. |
