...
| In Teams Android Phones Username is not displayed| Sidecar username is not displayed on navigating to calls tab or people tab. | No Workaround, the product team will release a fix in future releases. |
| In Teams Android Meeting Room Devices (MTRA Poly X50, X30, Yealink A20) no video for remote participants| Remote participants are not able to get video from meeting participants that are using Teams Rooms on Android devices. The issue is intermittent. | Reboot and rejoin, the product team will release a fix in future releases. |
| In Teams Android Phones random string displays | Issue occures in Firmware : 143.15.0.5 Teams app : 2022032303 CP : 5304 AA : 322, a random string character is displayed in more page when user set time format to be 24hours. | No workaround, the product team will release a fix in future releases. |
