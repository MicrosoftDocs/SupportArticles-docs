...
| Issue  |  Description | Workaround |
| --- | --- | --- |
|Teams Rooms on Android devices are unable to join a Zoom meeting. |Teams Rooms on Android devices that have a touch console aren't connecting to Zoom meetings.<br/><br/>This issue occurs because the front-of-room display doesn't receive a "connected" meeting status from the Zoom meeting service after the touch console joins the meeting. So the console ends the meeting after 60 seconds.|No workaround is available at this time.|
