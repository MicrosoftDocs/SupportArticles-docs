...
Exclude Teams.exe from the Symantec DLP's Endpoint agents as described in this [Symantec support article](https://knowledge.broadcom.com/external/article/160078/how-to-whitelist-or-exclude-an-applicati.html).
