---
title: Configure the ASP.NET Core application
description: This article describes how to configure the ASP.NET Core application to start automatically under a different user.
ms.date: 03/29/2021
ms.prod: aspnet-core
ms.reviewer: ramakoni
---
# Part 2.3.1 - [Optional] Configuring the ASP.NET Core application to start automatically under a different user

_Applies to:_ &nbsp; .NET Core 2.1, .NET Core 3.1  

This article introduces how to configure the ASP.NET Core application to start automatically under a different user.
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/adduser.png" alt-text="BuggyAmb adduser" border="true":::
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/cat.png" alt-text="BuggyAmb cat" border="true":::
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/difference.png" alt-text="BuggyAmb difference" border="true":::
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/usermod.png" alt-text="BuggyAmb usermod" border="true":::
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/firstappuser.png" alt-text="BuggyAmb firstappuser" border="true":::
...
:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/htop.png" alt-text="BuggyAmb htop" border="true":::

And here is the output of the `htop -p <PID>` command.

:::image type="content" source="./media/2-3-1-configure-aspnet-core-application-start-automatically/htop-p.png" alt-text="BuggyAmb htop-p" border="true":::
