...
This article describes an issue in which you can't connect to a Microsoft cloud service such as Office 365, Azure, or Microsoft Intune by using the `Connect-MSOLService` cmdlet. A resolution is provided.
...
- ["Connect-MsolService: Exception of type was thrown" error when you use the connect-MSOLService cmdlet to connect to Office 365, Azure, or Intune](https://support.microsoft.com/help/2887306)
- ["Access Denied" error when you use the connect-MSOLService cmdlet to connect to Office 365, Azure, or Intune](https://support.microsoft.com/help/2887685)
- ["The user name or password is incorrect" error when you use the connect-MSOLService cmdlet to connect to Office 365, Azure, or Intune](https://support.microsoft.com/help/2887705)
