...
## <a name="enable-tls-12" />Enable TLS 1.2 on client or server operating systems
...
## <a name="update-configure-tls-12" />Update and configure .NET Framework to support TLS 1.2
