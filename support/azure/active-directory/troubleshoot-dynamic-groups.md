...
Sign into the [Azure portal](https://ms.portal.azure.com/).
...
2. Ensure that the user creating the group has the appropriate administrator permissions:
   ...
   - Ensure that the user is authorized to create a new group. Global administrators can disable group creation in the Azure portal or Access Panel. The user may need an administrator create the new group for them, or give the user appropriate permissions.
...
*** `<Any customer-ready method for this? Or call Support to provide log analysis?>` ***
...
## Opening a support request: Information you will need

Basic Information to collect to facilitate troubleshooting with a support engineer, such as:
...
Your support engineer may assist you in creating audit logs for analysis
