...
|---------|---------|---------|
| 622|Full password hash synchronization completed for the domain `contoso.local`|Full password synchronization cycle finishes retrieving the recent passwords from the on-premises AD DS domain.|
| 623|Full password hash synchronization completed for the forest `contoso.local`|Full password synchronization cycle finishes retrieving the recent passwords from the on-premises AD DS forest.|
