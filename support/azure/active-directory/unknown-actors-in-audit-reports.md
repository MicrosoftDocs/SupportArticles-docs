...
|---|---|---|
|Azure Credential Configuration Endpoint Service|Auth Methods Registration|It is  used when [AAD Authentication Methods](/entra/identity/authentication/howto-mfa-userdevicesettings#add-authentication-methods-for-a-user) are registered. May show as an actor in audit logs during combined registration method addition as well.|
