...
|---|---|---|
|Azure Credential Configuration Endpoint Service|Auth Methods Registration|It is  used when [AAD Authentication Methods](https://learn.microsoft.com/en-us/entra/identity/authentication/howto-mfa-userdevicesettings#add-authentication-methods-for-a-user) are registered. May show as an actor in audit logs during combined registration method addition as well.|
...
|DaRT Team|Partner Center|The operation "Set Partnership" means DAP is terminated by Microsoft. This is an expected scenario as part of the MS-Led DAP deprecation effort.|
...
|Microsoft Managed Policy Manager|Microsoft Managed Conditional Access|Used to create and manage [Microsoft Managed Conditional Access Policies](https://learn.microsoft.com/en-us/entra/identity/conditional-access/managed-policies).|
