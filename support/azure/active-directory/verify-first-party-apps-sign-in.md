...
> [!NOTE]
> First-party Microsoft applications don't always result in a service principal created in your tenant. In this case, you will likely continue to see the applications in your sign-in reports. The article lists the [application IDs for commonly used Microsoft applications](#application-ids-for-commonly-used-microsoft-applications).
