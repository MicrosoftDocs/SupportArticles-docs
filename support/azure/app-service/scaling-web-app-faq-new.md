---
title: Web apps scaling FAQ - Azure App Service
...
# Web apps scaling FAQ for Azure App Service

## Summary

This article answers frequently asked questions (FAQ) about scaling [web apps in Azure App Service](https://azure.microsoft.com/services/app-service/web). Learn how to scale up, configure autoscale, understand instance limits, and troubleshoot common scaling issues.
