...
:::image type="content" source="media/web-troubleshoot-performance-degradation/1-monitor-metrics.png" alt-text="Screenshot of the metrics section under Monitoring.":::
...
:::image type="content" source="media/web-troubleshoot-performance-degradation/2-restart.png" alt-text="Screenshot of the app menu bar with stop and restart buttons.":::

You can also manage your app using Azure PowerShell. For more information, see [Manage Azure resources by using Azure PowerShell](/azure/azure-resource-manager/management/manage-resources-powershell).
