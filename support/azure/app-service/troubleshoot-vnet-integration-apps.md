...
**Subnet/VNet deletion issue** - This troubleshooter will check if your subnet has any locks and if it has any unused Service Association Links that might be blocking the deletion of the VNet/subnet. To delete any unused Service Association Links, see the [App Service virtual network integration troubleshooting steps](/azure/app-service/overview-vnet-integration.md#troubleshooting).
