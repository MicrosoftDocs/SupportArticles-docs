...
1. Set the file name to **.user.ini**.
1. Select the pencil icon next to **.user.ini**.
1. In the file, add this code: `log_errors=on`
1. Select **Save**.
1. Select the pencil icon next to **wp-config.php**.
1. Change the text to the following code:
...
## How do I troubleshoot Java Database Connectivity (JDBC) driver connection errors?
...
If you try to copy live log files for a Java app (for example, Tomcat), you might see this File Transfer Protocol (FTP) error:
...
If you forget your WordPress sign-in password, you can use WordPress Buddy+ to update it.
