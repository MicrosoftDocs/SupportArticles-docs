...
- Rewrite rules are only available on the **Application Gateway v2 SKU** (Standard_v2 and WAF_v2). If you are still using the v1 SKU, you will have to [migrate to v2](/azure/application-gateway/migrate-v1-v2) first.
...
![update-rewrite-set.png](media/troubleshoot-url-rewrite-rules/update-rewrite-set.png)
