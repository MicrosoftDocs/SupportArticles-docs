...
Exit codes 7147 and 7148 indicate that the container group is stopped due to platform maintenance, which is an expected behavior. For more information, check [Diagnose common code package errors by using Service Fabric - Azure Service Fabric](/azure/service-fabric/service-fabric-diagnostics-code-package-errors#how-can-i-tell-if-service-fabric-terminated-my-code-package)
