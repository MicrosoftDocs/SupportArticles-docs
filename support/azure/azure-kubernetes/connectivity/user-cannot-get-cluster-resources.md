---
title: User gets "Forbidden" message when accessing cluster resources in Azure Kubernetes Service
...
---
# "Forbidden" error when trying to access AKS cluster resources
...
Additionally, in Microsoft Entra ID integrated clusters, a ClusterRoleBinding resource is automatically created to grant members of a pre-designated Microsoft Entra ID group the permissions to fully administer the cluster likes administrator access to the cluster.
