---
title: Changing property imageReference isn't allowed
description: Troubleshoot the Changing property imageReference isn't allowed error message that occurs when you upgrade or scale an Azure Kubernetes Service (AKS) cluster.
ms.date: 10/10/2024
...
---
# "Changing property 'imageReference' isn't allowed" error message while upgrading or scaling an AKS cluster
