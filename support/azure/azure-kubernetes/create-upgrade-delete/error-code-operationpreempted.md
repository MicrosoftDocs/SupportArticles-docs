...
Retry the operation after the in-progress operation finishes or abort the long-running operation. For additional information on the abort operation, please refer to the [documentation](/azure/aks/manage-abort-operations).
