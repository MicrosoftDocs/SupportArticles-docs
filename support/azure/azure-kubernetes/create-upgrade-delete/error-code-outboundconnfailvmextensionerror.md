...
3. Select "Connectivity analysis (Preview)" from the toolbar at the top of the page. If you don't see it, click on the three dots "..." in the toolbar at the top of the page to open the expanded menu. :::image type="content" source="../media/error-code-outboundconnfailvmextensionerror/node-pool-connectivity-analysis-preview.png" alt-text="A user runs connectivity analysis on a selected nodepool." lightbox="../media/error-code-outboundconnfailvmextensionerror/node-pool-connectivity-analysis-preview.png":::
