...
description: Resolve the LoadBalancerInUseByVirtualMachineScaleSet or NetworkSecurityGroupInUseByVirtualMachineScaleSet error to delete your AKS cluster successfully. Start now.
ms.date: 11/21/2024
editor: v-jsitser
