...
description: Resolve AKS cluster deletion errors when public IP addresses, subnets, or network security groups are in use. Follow steps to delete the cluster successfully.
ms.date: 12/04/2024
editor: v-jsitser
