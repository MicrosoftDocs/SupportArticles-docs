...
> CSE failed with 'VMExtensionError_K8SAPIServerDNSLookupFail'. Agents are unable to resolve Kubernetes API server name.

The error message may include additional diagnostic details such as:
