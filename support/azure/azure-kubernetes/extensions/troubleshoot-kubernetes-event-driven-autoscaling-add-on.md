...
description: Learn how to troubleshoot the Kubernetes Event-driven Autoscaling (KEDA) add-on in AKS, fix common scaling errors, and restore autoscaling now.
