...
- The [kubectl-aks](https://github.com/Azure/kubectl-aks#install) plugin for running commands directly on AKS nodes without using the Kubernetes control plane.
