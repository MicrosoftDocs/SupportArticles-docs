...
description: Learn why Azure activity logs stop forwarding and scripts fail after moving to diagnostic settings, and how to fix the problem.
ms.date: 03/31/2026
ms.author: jarrettr
ms.editor: v-gsitser
...
- **Solution 1**: Double-check the diagnostic settings to amke sure that all parameters are correct.
