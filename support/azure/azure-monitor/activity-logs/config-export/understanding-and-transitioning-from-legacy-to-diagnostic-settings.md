...
We're retiring the Azure legacy solution for forwarding activity logs, and replacing it with diagnostic settings. This change is automatic. However, users who have automation that relies on the legacy API must update their configurations. This guide will help you verify your current setup and make necessary adjustments.
