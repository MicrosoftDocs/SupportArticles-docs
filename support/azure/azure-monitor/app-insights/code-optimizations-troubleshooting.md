...
:::image type="content" source="performancepage.png" alt-text="Navigating to app insights profiler":::
:::image type="content" source="profilingsessions.png" alt-text="Screenshot of profiling sessions page":::
## Keep checking back
