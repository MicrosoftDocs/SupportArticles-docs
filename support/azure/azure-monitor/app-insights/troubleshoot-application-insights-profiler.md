...
description: Provides troubleshooting steps and information to use Azure Application Insights Profiler.
ms.date: 03/01/2023
...
> [!NOTE]
> The Azure Functions consumption plan isn't supported. See [Profile live Azure Functions app with Application Insights](/azure/azure-monitor/profiler/profiler-azure-functions).
...
When you configure Profiler, updates are made to the web app's settings. If necessary, you can [apply the updates manually](/azure/azure-monitor/profiler/profiler#verify-always-on-setting-is-enabled).
...
To check the settings that were used to configure Azure Diagnostics, follow these steps:
...
1. When the trace is being uploaded, the "Start to upload trace" message is displayed.
