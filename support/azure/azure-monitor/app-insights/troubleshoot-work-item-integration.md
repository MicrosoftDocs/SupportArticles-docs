...
* For Azure DevOps, make sure that you have *Contribute* permissions.
* For GitHub, verify that you have *Write* access to the repository.
* If you're using a Personal Access Token (PAT), make sure that it includes *the Work Items (read/write)* scope.
