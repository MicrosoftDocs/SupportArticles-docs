...
4. The client sent PutBlockList to the destination storage to commit the blocks and finish the process after a receiving success response code from the request.
