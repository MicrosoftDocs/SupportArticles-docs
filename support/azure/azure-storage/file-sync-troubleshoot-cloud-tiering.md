...
| 0x80C86057 | -2134351785 | ECS_E_STABLEVERSION_SVID_CHECK_FAILED | The file cannot be tiered due to a known issue. | No action required. Ignore the error and the error will no longer appear once a fix is released. |
...
| 0x80C86057 | -2134351785 | ECS_E_STABLEVERSION_SVID_CHECK_FAILED | The file cannot be recalled due to a known issue. | Copy the file manually from a different endpoint or from the cloud share. If you are unable to copy the file manually, create a support ticket. |
