...
- Check the firewall settings of storage account to ensure that the exception "_Allow Azure services on the trusted services list to access this storage account_" is granted. You can refer [this](/azure/storage/common/storage-network-security?tabs=azure-portal#manage-exceptions) link for the steps to grant the exception.
