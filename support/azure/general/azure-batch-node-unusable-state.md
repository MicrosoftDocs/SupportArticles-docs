...
Classic node communication is the original communication way for a pool that's associated with a subnet of a virtual network (VNet), this feature will be replaced with simplified communication node in 2026.
