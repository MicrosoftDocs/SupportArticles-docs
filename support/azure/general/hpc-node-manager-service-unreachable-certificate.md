...
A compute node's health is in error state, and the note connectivity shows the "HPC Node Manager Service Unreachable" error in the HPC management console.
