...
> [!NOTE]
> To get more information about why the scheduling fails, check the [scheduler](https://github.com/Azure/fleet/blob/main/pkg/scheduler/scheduler.go) logs.
