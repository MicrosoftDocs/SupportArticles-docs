...
This article provides troubleshooting information for common questions about Azure Load Balancer (Basic and Standard tiers). For more information about Standard Load Balancer, see the [Standard Load Balancer overview](/azure/load-balancer/load-balancer-standard-diagnostics).
...
If you recently moved from a Basic ILB to a Standard ILB and need outbound connectivity to the internet from your VMs, you can configure [Azure NAT Gateway](/azure/virtual-network/nat-gateway/nat-overview) on your subnet. We recommend NAT Gateway for all outbound access in production scenarios.
