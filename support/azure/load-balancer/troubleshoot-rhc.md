...
As outlined in the [this article about resource health](/azure/load-balancer/load-balancer-standard-diagnostics#resource-health-status), a degraded load balancer shows between 25% and 90% for Data Path Availability. An unavailable load balancer is one with less than 25% for Data Path Availability over a two-minute period.
