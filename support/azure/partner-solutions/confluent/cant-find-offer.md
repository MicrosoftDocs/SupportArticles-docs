...
# customer intent: As an Azure administrator or user, I want to resolve problems with finding the Apache Kafka & Apache Flink offer in Azure Marketplace so that I can create a resource.
