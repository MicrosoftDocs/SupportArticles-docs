...
# customer intent: As an Azure administrator or user, I want to understand the limitations of using a Dynatrace free trial on Azure so that I can work around them and/or prepare for resource deletions.

---

# Free trial limitations

This article helps you understand limitations that you might encounter when creating or managing Dynatrace free trial resources on Azure, including resource creation limits and resource deletion after trial expiration.
 
## Symptoms

- You get an error when attempting to create another Dynatrace free trial resource.
- The Dynatrace free trial resource is missing or deleted after the trial period ends.
