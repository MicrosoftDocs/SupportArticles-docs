...
1. Use [Azure Monitor - Networks](/azure/network-watcher/network-insights-overview#resource-view) for insights and to see a resource view of the resources by going to:
...
* [Create a private link service (CLI)](/azure/private-link/create-private-link-service-cli)
 
* [Azure Private Endpoint troubleshooting guide](/azure/private-link/troubleshoot-private-endpoint-connectivity)