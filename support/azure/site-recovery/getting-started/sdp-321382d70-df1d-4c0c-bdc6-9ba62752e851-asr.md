...
description: Learn what the Microsoft Azure Recovery Services troubleshooter collects for Branch to Azure scenarios and use this summary to speed up troubleshooting.
...
Use the Microsoft Azure Recovery Services troubleshooter to collect and analyze data for Branch to Azure scenarios, helping resolve issues faster.

## More information

Microsoft Support uses this tool as a general data collection tool to help gather multiple logs, debug traces, registry and file data, and the output of various PowerShell cmdlets. Collecting these files individually can be a time-intensive and error-prone process. By using this diagnostic, the support professional assisting you gets all the data that's typically required to resolve most issues after running this wizard.

This package is for stand-alone Hyper-V servers that have Microsoft Azure Site Recovery Provider for Hyper-V installed. For Azure Recovery Services computers that System Center 2012 R2 Virtual Machine Manager (SC 2012 R2 VMM) protects, use the [VMM SDP](https://aka.ms/vmmdiag).
...
| Description| File name |
|---|---|
|Decoded Azure Recovery Services ETL trace. File name is in the format `Azure Recovery ServicesDebug-0001.txt`.</br>|`{ComputerName}_Azure Recovery Servicesdebug-<RANDOM4DIGITNUMBER>.txt`</br>|
  
#### Azure Recovery Services event logs

|Description|File name|
|---|---|
|Application event log for last seven days in EVTX, CSV, and text format.|{ComputerName}_evt_Application.[evtx\|csv\|txt]|
|System event log for last seven days in EVTX, CSV, and text format.|{ComputerName}_evt_System.[evtx\|csv\|txt]|
|FailoverClustering log for last seven days in EVTX, CSV, and text format.|{ComputerName}_FailoverClustering.[evtx\|csv\|txt]|
|Microsoft-VirtualMachineManager-Server/Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_evt_Microsoft-VirtualMachineManager-Server-Admin.[evtx\|csv\|txt]|
|Microsoft-VirtualMachineManager-Server/Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_evt_Microsoft-VirtualMachineManager-Server-Operational.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-Config-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-Config-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-Config-Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-Config-Operational.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-EmulatedNic-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-EmulatedNic-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-EmulatedNic-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-Hypervisor-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-Hypervisor-Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-Hypervisor-Operational.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-Integration-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-Integration-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-SynthFc-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-SynthFc-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-SynthNic-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-SynthNic-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-SynthStor-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-SynthStor-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-SynthStor-Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-SynthStor-Operational.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VID-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VID-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VMMS-Admin log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VMMS-Admin.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VMMS-Networking log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VMMS-Networking.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VMMS-Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VMMS-Operational.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VMMS-Storage log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VMMS-Storage.[evtx\|csv\|txt]|
|Microsoft-Windows-Hyper-V-VmSwitch-Operational log for last seven days in EVTX, CSV, and text format.|{ComputerName}_Microsoft-Windows-Hyper-V-VmSwitch-Operational.[evtx\|csv\|txt]|
|VM Manager log for last seven days in EVTX, CSV, and text format.|{ComputerName}_evt_VM Manager.[evtx\|csv\|txt]|
