...
- [Troubleshoot a slow query on a dedicated SQL pool](../../../../azure/synapse-analytics/dedicated-sql/query-execution-performance/troubleshoot-dsql-perf-slow-query.md)
