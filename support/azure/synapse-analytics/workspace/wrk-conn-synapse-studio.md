...
|---------|-------|------------|
|Error code 9054 occurs when can't connect to linked services.|Deployments of a workspace in GIT without the Managed Virtual Network|Add the Managed Virtual Network configuration to the template used for workspace deployment.|
