...
First, check [Unable to mount Azure file shares with AD credentials](../azure-storage/files/security/files-troubleshoot-smb-authentication.md#unable-to-mount-azure-file-shares-with-ad-credentials) to see if your problem is listed there.
