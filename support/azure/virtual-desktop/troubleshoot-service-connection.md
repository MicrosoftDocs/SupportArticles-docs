...
- The user is trying to sign in with the Windows App in a web browser but doesn't have access to both the Azure Virtual Desktop and Windows 365 apps through Conditional Access policies.
  > [!NOTE]
