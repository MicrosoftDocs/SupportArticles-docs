...
4. Modify the value of the `GRUB_DEFAULT` variable in the */etc/default/grub* file as instructed in [Change default kernel version manually](#bootingup-differentkernel-ARVMManual). This is a persistent change.
