...
- Microsoft will assist you with commercially viable support for Linux.
- Take the opportunity to explore the marketplace and you will also find others such as Rocky, AlmaLinux, Kali, and many more distributions available. Microsoft will support distributions such as these but may require customers to engage the vendor to further support which may incur a separate cost.
