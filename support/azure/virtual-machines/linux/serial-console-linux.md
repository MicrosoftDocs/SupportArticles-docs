...
Serial console may be unresponsive following a Live Migration for confidential VMs and VMs with Trusted Launch and Secure Boot enabled. | Serial console will be available following a subsequent reboot.
