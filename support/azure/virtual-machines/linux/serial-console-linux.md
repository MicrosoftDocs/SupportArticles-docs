...
Serial console may be unresponsive following a Live Migration for VMs with Trusted Launch and Secure Boot enabled. | Serial console will be available following a subsequent reboot.
