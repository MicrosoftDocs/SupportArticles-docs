...
|Rocky Linux from CIQ|<ul><li>[Rocky Linux from CIQ](https://azuremarketplace.microsoft.com/marketplace/apps?search=ciq&page=1)</li><li> Microsoft Support provides commercially reasonable support for these images.</li></ul>|
