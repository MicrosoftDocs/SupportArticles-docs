...
|Rocky Linux from CIQ|[Rocky Linux from CIQ](https://azuremarketplace.microsoft.com/marketplace/apps?search=ciq&page=1) <br><br> Microsoft Support provides commercially reasonable support for these images.|
