...
- In Azure Marketplace, Linux distributions are available. Microsoft assists with Linux support but may require customers to engage with Linux vendors for collaboration. Vendors may have to provide distribution-specific fixes.
