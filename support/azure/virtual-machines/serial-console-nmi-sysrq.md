...
:::image type="content" source="media/serial-console-nmi-sysrq/virtual-machine-serial-console-command-menu.png" alt-text="Screenshot of the Azure Serial Console. The keyboard icon is highlighted, and its menu is visible. That menu contains a Send SysRq Command item.":::
...
:::image type="content" source="media/serial-console-nmi-sysrq/virtual-machine-serial-console-command-menu.png" alt-text="Screenshot of the Serial Console. The keyboard icon is highlighted, and its menu is visible. That menu contains a Send Non-Maskable Interrupt item."::: <br>
