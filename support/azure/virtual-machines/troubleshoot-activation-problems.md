...
> [!NOTE]
> For VMs running **Windows 10 Enterprise multi-session** (also known as **Windows 10 Enterprise for Virtual Desktops**) in [Windows Virtual Desktop](virtual-desktop/overview), this step **is not** required.
>
...
>
> For more information, please refer to: [Windows 10 Enterprise multi-session FAQ](virtual-desktop/windows-10-multisession-faq#can-i-upgrade-a-windows-10-vm-to-windows-10-enterprise-multi-session)
