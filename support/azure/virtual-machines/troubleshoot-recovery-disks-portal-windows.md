...
description: Learn how to repair a VM by connecting the OS disk to a recovery VM through the Azure portal.
author: jc-mackin
...
:::image type="content" source="media/troubleshoot-recovery-disks-portal-windows/os-disk.png" alt-text="A screenshot of the Disks blade of a V M in Azure portal, showing the O S disk highlighted.":::
...
:::image type="content" source="media/unlock-encrypted-disk-offline/attach-existing.png" alt-text="Screenshot of the disks page of the create a virtual machine wizard, with the option highlighted to attach an existing disk.":::
