...
We strongly recommend creating a nested virtualization environment in Microsoft Azure and mount the disk of the faulty VM on the Hyper-V host (Repair VM) for troubleshooting this issue. For more information, see [Troubleshoot a faulty Azure VM by using nested virtualization in Azure](troubleshoot-vm-by-use-nested-virtualization.md).
