...
The following [Repair process example](#repair-process-example) section will guide you through the following process:

1. Launch Azure Cloud Shell.
2. Run `az extension add` or `az extension add update`.
