...
The serial console successfully connects to the VM, but no output is displayed, and user input is unresponsive. | Serial console and logs might not be available after live migration for Generation 2 virtual machines with Trusted Launch and Secure Boot enabled. To resolve this, a guest OS reboot is required.
