...
* [Troubleshoot Secure Shell (SSH) connections to a Linux-based Azure virtual machine](../linux/troubleshoot-ssh-connection.md).
...
* Redeploy the virtual machine
  ...
  * [Redeploy Linux VM](../linux/redeploy-to-new-node-linux.md)
