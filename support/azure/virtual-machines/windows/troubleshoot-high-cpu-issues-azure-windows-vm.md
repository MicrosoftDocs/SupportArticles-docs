...
PerfInsights is available for both the [Windows](./how-to-use-perfinsights.md) and [Linux](../linux/how-to-use-perfinsights-linux.md) OS. For Windows, here are the options.
