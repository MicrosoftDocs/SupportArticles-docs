...
**Windows**: [Check connectivity with Azure Network Watcher using PowerShell](/azure/network-watcher/connection-troubleshoot-manage)

**Linux**: [Check connectivity with Azure Network Watcher using Azure CLI 2.0](/azure/network-watcher/connection-troubleshoot-manage)
...
2. Find the corresponding resolution in the following table, and follow the indicated steps to resolve the issues.
    ...
    |DNS Resolution     |    Name of the DNS     |    Follow these steps: [Azure DNS troubleshooting guide](/azure/dns/dns-troubleshoot) and [Name resolution for resources in Azure virtual networks](/azure/virtual-network/virtual-networks-name-resolution-for-vms-and-role-instances).     |
