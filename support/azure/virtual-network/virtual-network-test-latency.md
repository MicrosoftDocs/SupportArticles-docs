...
- Enable [Accelerated Networking](/azure/virtual-network/accelerated-networking-overview) for increased performance.
...
- Allocate [virtual machine network bandwidth](/azure/virtual-network/virtual-machine-network-throughput).
- [Test bandwidth and throughput](/azure/virtual-network/virtual-network-bandwidth-testing).
- For more information about Azure virtual networking, see [Azure Virtual Network FAQ](/azure/virtual-network/virtual-networks-faq).