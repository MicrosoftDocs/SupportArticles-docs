...
4. In the Security level for this zone frame, click **Custom Level**. In Internet Explorer version 4.x, click **Custom Level**, and then click **Settings**.

5. View the Microsoft VM section (the Java section in Internet Explorer 4.x.)
...
For more information about Java permissions, see the following two books by Microsoft Press:  
