...
description: Find explanations, solutions, and workarounds for "Unable to set data breakpoint errors" that occur when using "Break when Value Changes" (.NET only).
ms.date: 09/12/2023
author: HaiyingYu
ms.author: haiyingyu
ms.reviewer: wardengnaw
f1_keywords:
...
For any issues or suggestions about this feature, please let us know via Help > Send Feedback > [Report a Problem](/visualstudio/ide/how-to-report-a-problem-with-visual-studio) in the IDE or in the [Developer Community](https://aka.ms/feedback/suggest?space=8).
