...
1. Repeat steps 5 and 6 to add another class file. Rename the class file `HelloWorldHandlerFactory`.
...
1. Open the **web.config** file, and then add the `<httpHandlers>` section in the `<system.web>` section as follows:
