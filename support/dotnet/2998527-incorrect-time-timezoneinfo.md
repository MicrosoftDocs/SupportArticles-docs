...
This article explains the issue that KB 2998527 causes incorrect code lookups on past dates when you use the `TimeZoneInfo` class in applications, and provides a resolution.
