...
description: Provides information about resolving an issue that the data placed on clipboard from Windows Forms Application is unavailable.
ms.date: 05/11/2020
ms.prod-support-area-path: 
---
# Data placed on clipboard from Windows Forms Application is unavailable

This article provides information about resolving an issue that the data placed on clipboard from an Windows Forms application is unavailable.
