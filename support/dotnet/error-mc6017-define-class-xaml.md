...
You have a Windows Presentation Foundation (WPF) application. You have a class such as a `UserControl` defined using XAML. You derive a class from the `UserControl`. For example:
