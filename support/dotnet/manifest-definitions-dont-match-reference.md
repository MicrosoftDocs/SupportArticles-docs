...
description: Describes when the Framework 3.5 Service pack 1 is installed and the ClickOnce store is used for the first time, cdf-ms files maybe deleted.
ms.date: 05/06/2020
ms.prod-support-area-path: 
---
# The located assembly's manifest definition doesn't match the assembly reference

This article provides information about resolving **The located assembly's manifest definition does not match the assembly reference** error that occurs when a ClickOnce application fails to run.
