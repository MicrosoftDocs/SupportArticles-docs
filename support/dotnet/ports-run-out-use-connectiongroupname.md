...
description: When you use a unique ConnectionGroup property of the System.Net.HttpWebRequest class of the .NET Framework 2.0 or 4.0, you may run out of available ports. Provides a resolution for this issue.
ms.date: 05/08/2020
ms.prod-support-area-path:
ms.reviewer: pphadke, chrross, pphadke
---
...
This article provides information about resolving the issue that you may run out of available ports when using the `ConnectionGroupName` property of the `System.Net.HttpWebRequest` class in Microsoft .NET Framework 2.0 or 4.0.
