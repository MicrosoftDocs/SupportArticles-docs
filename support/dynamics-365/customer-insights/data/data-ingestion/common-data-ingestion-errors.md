---
title: Common issues for data ingestion errors or corrupt data
description: Introduces some common issues for data ingestion errors or corrupt data when using Azure Data Lake Storage or Power Query in Dynamics 365 Customer Insights - Data.
ms.date: 12/25/2023
author: m-hartmann
ms.author: mhart
ms.reviewer: mhart
---
# Common issues for ingestion errors or corrupt data

[!INCLUDE [consolidated-sku](../../includes/consolidated-sku.md)]

There are several common issues that can cause data ingestion errors to occur in Microsoft Dynamics 365 Customer Insights - Data.

## Common issues for ingestion errors or corrupt data with Azure Data Lake Storage
...
In a *manifest.json* file, the `datetime` format can be specified at the table level or at the attribute level. At the table level, use `"exhibitsTraits"` in the table in the **.manifest.cdm.json* to define the `datetime` format. At the attribute level, use `"appliedTraits"` in the attribute in the *tablename.cdm.json*.
...
## Common issues for ingestion errors or corrupt data with Power Query
...
The data can be fixed at the source and reingested. Or fix the transformation within Customer Insights - Data. To fix the transformation:
