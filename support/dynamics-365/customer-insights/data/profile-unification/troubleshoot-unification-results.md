...
See how to [Remove a unified table](/dynamics365/customer-insights/data/data-unification-update#remove-a-unified-table). If there are downstream dependencies on the Customer table, then those must also be removed.
...
The Deduplication tables are the source tables deduplicated by the configured rules. If there are no configured rules, they are instead deduplicated by the columns referenced in match rules.
...
|Column    |Source|Type  |Description  |
|----------|------|------|-------------|
|TrueObjectId|System|String| The temporary identifier for records matched across source table(s)|
...
|Other matched fields|Source|Various|The remaining fields from the source table(s) that are mapped|
...
|-|-|-|-|-|
|100|Moni|Thomson|monica.thomson@outlook.com|1/1/2024 12:00 AM|
|200|Monica|Smith|monica.thomson@outlook.com|12/24/2020 12:00 AM|
...
|-|-|-|-|-|-|-|-|-|-|
|100|100;200|guid()|DedupOnEmailAddress|1.0|100|Moni|Thomson|monica.thomson@outlook.com|1/1/2024 12:00 AM|
...
|-|-|-|-|-|-|-|-|-|-|-|-|-|
|1__00|1|1;2|100|100;200|now()||Thomson|monica.thomson@outlook.com|Moni|Thomson|monica.thomson@outlook.com|1/1/2024 12:00 AM
...
|-|-|-|-|-|-|-|-|-|
|guid()|1|1;2|100|100;200|Moni|Thomson|monica.thomson@outlook.com|1/1/2024 12:00 AM|