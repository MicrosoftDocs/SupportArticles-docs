...
description: Provides a resolution for the authentication error that occurs on agent dashboard after provisioning Dynamics 365 Omnichannel for Customer Service.
...
4. Select the admin app like Customer Service admin center, and then select **Channel provider**. The **Active Channel Providers** list is displayed.
