...
**No, asking a knowledge question does not change data.**
...
| Input | Description | Required |
|---|---|---|
| `language` | `language` (optional). BCP 47 language code for the response (e.g. `en-us`). Defaults to `en-us`. | No |
