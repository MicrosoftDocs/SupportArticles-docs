...
The assistant displays a text response confirming the assignment result, or asks you to choose from candidate targets when a display name matches more than one user, team, or queue. There is no interactive app-in-chat component for this capability.
