...
- Do not run it before harvesting; the harvest pipeline already performs its own duplicate check.
...
**This can create or update backend check state, but it does not publish or delete knowledge articles.**
