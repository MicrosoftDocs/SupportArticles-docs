...
Use this capability when you've resolved a customer's issue and want to close the case with a resolution note.
...
Closes the case via the Dataverse CloseIncident action, creating a resolution activity record. The case state transitions to Resolved.
