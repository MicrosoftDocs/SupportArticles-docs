...
**No, viewing the case form does not change data.**
...
The form itself does not change data. Follow-up actions from the form (update, reassign, close) can trigger write operations via separate tools.
