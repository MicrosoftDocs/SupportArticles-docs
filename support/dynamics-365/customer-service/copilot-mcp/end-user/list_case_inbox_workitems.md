...
## What it does
The assistant shows your personal case inbox: active cases assigned to you that have been modified in the last 90 days. Cases are sorted by priority (highest first) and then by most recently modified. This gives you a quick view of what's on your plate.
...
**No, viewing your inbox does not change data.**
...
The inbox listing does not change data. Follow-up actions from the grid can trigger write operations via separate tools.
