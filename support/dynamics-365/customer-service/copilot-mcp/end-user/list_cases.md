...
**No, listing cases does not change data.**
...
The listing itself does not change data. Follow-up actions from the grid (update, reassign, close) can trigger write operations via separate tools.
