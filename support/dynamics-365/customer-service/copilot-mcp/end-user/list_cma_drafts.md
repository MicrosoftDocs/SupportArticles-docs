...
## What it does
The assistant retrieves AI-generated email drafts that the Case Management Agent (CMA) has prepared for a specific case. You see draft summaries showing the subject, recipient, and a snippet of the content. If multiple drafts are available, they appear in a selection grid where you can pick one to review in full.

## Try prompts like
- "Show me the drafted emails for CAS-01010-A0A0A0"
- "Any pending CMA drafts on this case?"
