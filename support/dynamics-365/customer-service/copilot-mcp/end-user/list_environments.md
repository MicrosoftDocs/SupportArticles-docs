...
## What it does
The assistant shows an interactive environment picker with all the Dynamics 365 organizations available in your tenant. You can click on any environment to connect to it. This is useful when you have multiple orgs (for example, production and test environments) and need to switch between them.
