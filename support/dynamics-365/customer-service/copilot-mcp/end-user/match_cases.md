...
The assistant shows a text list of up to 5 candidate cases with match scores, case numbers, titles, and statuses.
...
> [!TIP]
> After finding a match, say "link this email to case CAS-01010-A0A0A0" to associate them, or "create a case from this email" if none match.
...
**No, matching cases does not change data.**

The match uses existing search indices and does not modify any records. Linking or creating a case from the email are separate actions.
