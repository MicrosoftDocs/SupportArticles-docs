...
Use this capability when you want to transfer a case to a different person, team, or queue with a handover note explaining why.
...
The assistant confirms the reassignment with a text response, including who the case was reassigned to and the reason. No interactive component is displayed.
...
> [!TIP]
> A clear handover note saves the next agent time. Include what you've already tried and what still needs to be done.
