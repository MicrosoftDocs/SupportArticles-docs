...
Use this capability when you want to see which email templates are available and best suited for a specific case.
...
This is the browsing step before applying a template. Once you find the right template, you can ask the assistant to apply it to the case, which opens the compose form with the template content and merge fields filled in.
...
**No, recommending templates does not change data.**
