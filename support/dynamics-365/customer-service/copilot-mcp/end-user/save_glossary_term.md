...
| `destructiveHint` | `false` | Creates or updates; does not delete. |
...
This tool returns a text result indicating success and the saved id. It does not render its own app-in-chat component; it's used by the Manage Customer Service vocabulary editor.
