...
## What it does
This tool saves tool visibility overrides. You can hide tools at the org level, hide additional tools for a profile, or restore a tool that was hidden at the org level when working in profile scope.
