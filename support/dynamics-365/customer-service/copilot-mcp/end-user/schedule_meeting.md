...
- Provide start and end times as ISO 8601 date-times with an explicit timezone offset (e.g. `2026-07-20T15:00:00Z` or `2026-07-20T15:00:00+05:30`); the end must be after the start.
...
| `destructiveHint` | `false` | Creates an appointment; does not delete records. |
...
| `scheduledStart` | Meeting start as an ISO 8601 date-time with an explicit timezone offset (e.g. `2026-07-20T15:00:00Z`). | Yes |
