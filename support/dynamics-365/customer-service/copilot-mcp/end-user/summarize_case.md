...
Use this capability when you want to quickly understand what a case is about and see an AI-generated summary of the situation.
...
**No, viewing the case summary does not change data.**
...
The summary itself does not change data (though it triggers an LLM call). Follow-up actions from the form (update, reassign, close) can trigger write operations via separate tools.
