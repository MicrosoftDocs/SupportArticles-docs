...
**No, translating an email does not change data.**
...
The tool itself is marked with `readOnlyHint: true` and does not write to Dataverse on its own. The translation shown in chat is a preview.
