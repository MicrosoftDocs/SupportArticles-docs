...
Solution export isn't intended to export data and only intended to export configurations. So, if the solution is imported with the **Maintain Customizations** option enabled and SLAs are already present and active in target org, the import will fail.  
