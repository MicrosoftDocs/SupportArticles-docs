...
|Your microphone is not working. Open More -> Device settings to connect to a different device or try reconnecting this one.  | `microphoneMuteUnexpectedly`|
|Your microphone is not working. Open More -> Device settings to connect to a different device or try reconnecting this one.  | `microphoneNotFunctioning`|
