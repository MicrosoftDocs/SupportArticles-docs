...
When you try to delete SLAs or SLA items during a solution upgrade or manual deletion, one of the following error messages occur:
...
Instead of deleting the SLA, deactivate the SLA in your organization. If it's a part of a managed solution, then take the following steps:
...
1. In your organization, go to **Advanced Find**, search for *SLA KPI Instances*, and then select the **SLAItem**.
