---
title: Troubleshoot SLA issues in Customer Service
...
# Troubleshoot service-level agreement issues in Customer Service

This article explains the various issues related to SLAs and provides reasons and steps to resolve them.

## Issue 1 - Primary entity isn't available while creating SLAs
...
## Issue 3 - Unable to use the SLA migration tool to migrate a large number of SLAs
...
## Issue 4 - Warning and failure duration times are incorrect for the SLA
...
## Issue 5 - Errors on custom time calculation for SLA
...
## Issue 6 - SLA KPI instance doesn't reach Nearing Non-compliance or Non-compliant state, and the SLA KPI instance timer continues to run
...
## Issue 7 - Warning message appears on slakpiinstances
...
## Issue 8 - SLA timer doesn't pause when its state is changed from InProgress to OnHold on a holiday
...
## Issue 9 - OnHold Time attribute isn't populated for Case for Unified Interface SLA
...
## Issue 10 - Unable to import solution with active SLAs and SLAs are deactivated when a solution is imported
...
## Issue 11 - Unable to create entitlements because Allocation Type dropdown doesn't show any options
...
## Issue 12 - SLA KPI instance status shows as canceled
...
## Issue 13 - Success, warning, and failure actions are being run multiple times in web client
...
## Issue 15 - SLA KPI instance isn't created on the entity
...
## Issue 16 - Errors occur while updating a case
...
## Issue 17 - modifiedon and modifiedby fields on the case entity get updated
...
## Issue 18 - Unable to delete a managed solution consisting of an SLA-enabled entity
