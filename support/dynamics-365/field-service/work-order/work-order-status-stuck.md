...
### Resolution for Cause 1: Review status transition rules
...
### Resolution for Cause 2: Close open sub-records
...
### Resolution for Cause 3: Identify and fix custom plug-ins
