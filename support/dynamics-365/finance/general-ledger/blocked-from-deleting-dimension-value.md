...
- **Resolution 1:** Delete the dimension value from the corresponding entity page. For example, to delete a Department dimension, go to the **Operating units** page.

**Potential Cause 2:** The user lacks sufficient roles or privileges to manage dimension values.

- **Resolution 2:** Verify that an administrator with full privileges can delete the dimension value. Contact your system administrator to request the necessary permissions.
