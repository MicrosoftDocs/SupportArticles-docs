...
description: Describes different reasons why transactions can't be reversed. It also lists solutions for this issue in Microsoft Dynamics 365 Finance.
author: kweekley
ms.date: 11/20/2023
ms.prod: 
ms.technology: 
...
This article describes different reasons why transactions can't be reversed in Microsoft Dynamics 365 Finance. It also provides solutions for this issue.
...
If the **Mass reversals for multiple documents** feature (also known as the Mass reversal feature) is turned on in the **Feature management** workspace, it affects how many transactions can be reversed and where they can be reversed. This feature provides two benefits when it's turned on:
