...
> 
> If you can't install the add-in because the **Power platform integration** section isn't available, see [Add-in overview](/dynamics365/fin-ops-core/dev-itpro/power-platform/add-ins-overview). If you still encounter the error after you install the add-in, contact your system administrator.
> 
