...
The following errors might occur when you try to close an opportunity:
...
One of the following issues might cause the opportunity close dialog to open incorrectly:
...
The user who's trying to close the opportunity doesn't have sufficient permissions on the opportunity that they're working on.
