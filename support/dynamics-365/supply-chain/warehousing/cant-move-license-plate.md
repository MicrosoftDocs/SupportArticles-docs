...
description: You can't move a license plate if the serial number has Blank issue and Blank receipt allowed. This issue has been fixed by making the serial number field optional. 
author: Mirzaab 
ms.date: 06/24/2021 
