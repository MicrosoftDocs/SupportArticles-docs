...
1. If you find a mismatch, cancel the relevant work, reconfigure the location directive, and re-release the load. For instructions, see [You can't confirm a shipment because items haven't been picked](some-items-not-picked-moved-to-final-shipping-location.md).
