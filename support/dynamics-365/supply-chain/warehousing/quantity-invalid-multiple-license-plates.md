...
description: Provides a resolution for the issue that the quantity is not valid when there is picking work with multiple license plates in one location.
author: Mirzaab 
ms.date: 06/24/2021 
