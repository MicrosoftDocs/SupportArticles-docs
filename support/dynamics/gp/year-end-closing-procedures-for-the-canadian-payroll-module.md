...
2. In Microsoft Dynamics GP, point to **Tools** on the Microsoft Dynamics GP menu, point to **Routines** > **Payroll - Canada**, and then select **Year End File Reset**.
...
1. In Microsoft Dynamics GP, point to **Tools** on the Microsoft Dynamics GP menu, point to **Routines** > **Payroll - Canada**, and then select **T4 and R1 Creation**.
...
1. In Microsoft Dynamics GP, point to **Tools** on the Microsoft Dynamics GP menu, point to **Routines** > **Payroll - Canada**, and then select **T4 and R1 Summary**.
...
1. In Microsoft Dynamics GP, point to **Tools** on the Microsoft Dynamics GP menu, point to **Routines** > **Payroll - Canada**, and then select **T4 and R1 Print**.
...
1. In Microsoft Dynamics GP, point to **Tools** on the Microsoft Dynamics GP menu, point to **Routines** > **Payroll - Canada** > **T4A Routines**, and then select **T4A Print**.
2. In the **Employer Number** field, select the appropriate employer number.
