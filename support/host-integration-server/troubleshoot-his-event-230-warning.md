...
description: Describes how to troubleshoot Host Integration Server Event 230 warnings.
ms.date: 05/11/2020
ms.prod-support-area-path:
---
# Troubleshooting Host Integration Server Event 230 warnings
...
7. Highlight the link service name (for example, SNADLC1) used by the 802.2 DLC connection identified in the Event 230 warning and then click **Properties**.
8. Click the **Message Trace** tab.
9. Enable Level 2 Messages and then click **OK**.
10. Highlight SnaServer in the list of **Trace Items** and click **Properties**.
