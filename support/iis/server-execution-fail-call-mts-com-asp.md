...
description: This article provides resolutions for the problem that server execution fails when you call an MTS COM Component from ASP.
ms.date: 03/24/2020
...
This article helps you resolve the problem that server execution fails when you call an Microsoft Transaction Server (MTS) Component Object Model (COM) component from Active Server Pages (ASP)
