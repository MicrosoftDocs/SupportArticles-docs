...
If you experience either of these issues, this article provides some steps you can use to troubleshoot. For more in-depth troubleshooting, see [Troubleshooting application deployment technical reference](/mem/configmgr/apps/understand/app-deployment-technical-reference).
...
If these actions don't resolve the issue, check the client status. There may be a deeper underlying problem with the client. For more information, see [How to monitor clients](/mem/configmgr/core/clients/manage/monitor-clients).

## Next steps

- [Monitor applications](/mem/configmgr/apps/deploy-use/monitor-applications-from-the-console)
- [Deploy applications](/mem/configmgr/apps/deploy-use/deploy-applications)
- [Management tasks for applications](/mem/configmgr/apps/deploy-use/management-tasks-applications)
- [Troubleshooting application deployment technical reference](/mem/configmgr/apps/understand/app-deployment-technical-reference)
