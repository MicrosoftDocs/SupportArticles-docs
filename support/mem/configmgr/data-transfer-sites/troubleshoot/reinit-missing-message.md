...
To detect the issue and reinit, run the [Replication Link Analyzer](/intune/configmgr/core/servers/manage/monitor-replication#BKMK_RLA).
...
For more information, see [InitializeData method in class SMS_ReplicationGroup](/intune/configmgr/develop/reference/core/servers/configure/initializedata-method-in-class-sms_replicationgroup).
