...
Configuration Manager management points stop responding to client requests. When you use a web browser to connect to the management point list address ([http://\<*ServerName*>/sms_mp/.sms_aut?mplist](https://\<*ServerName*>/sms_mp/.sms_aut?mplist)), you receive this error message:
