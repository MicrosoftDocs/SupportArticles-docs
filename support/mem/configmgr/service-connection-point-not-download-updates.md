...
As a workaround, you can download the [Baltimore CyberTrust Root certificate](https://cacerts.digicert.com/BaltimoreCyberTrustRoot.crt). You can also export the certificate from the certificate authority in your environment.
