...
:::image type="content" source="media/windows-server-update-services-best-practices/advanced-settings.png" alt-text="Screenshot of the changes in the Advanced Settings window.":::
