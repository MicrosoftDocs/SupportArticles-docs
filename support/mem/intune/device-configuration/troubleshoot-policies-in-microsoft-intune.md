...
4. Under **Devices**, find the device having an issue. Review the different columns:
    ...
    - - **Last check in**: Should be a recent time and date. By default, Intune devices check in every 8 hours and the Last check-in value in the Intune portal also updates every 8 hours.
