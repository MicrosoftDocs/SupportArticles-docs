...
| **2004**                | "There's a problem with `{Skill Name}` in `{Topic Name}`. Please check your content."                                                                                    | A problem affects your skill. Check both [the skill][8] and [topic][9] for errors messages.                                                                                                                                 |
...
| **2015**                | "You're not authorized to call `{Skill Name}`. Please check the skill and its usage for any issues."                                                                     | Check your [skill's configuration][15], an your bot is [added to the skill's allowlist][18].                                                                                                                       |
