...
To solve this issue, you can [disable the Administration mode](/power-platform/admin/admin-mode#set-administration-mode) or take the following steps to ensure the user is assigned the appropriate security role when **Administration mode** is enabled:
