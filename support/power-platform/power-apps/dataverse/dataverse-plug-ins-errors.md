...
This error can ocurr during a <xref:System.TimeZoneInfo.ConvertTimeToUtc(System.DateTime,System.TimeZoneInfo)?displayProperty=fullName> call in plug-in code to convert a DateTime value in Santiago or Volgograd time zones to UTC.
