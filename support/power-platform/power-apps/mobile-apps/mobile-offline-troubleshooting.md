...
|We are unable to sync offline data for you. No profile assigned to the user. | Make sure the user is added to a mobile offline profile. For more information, see [Set up mobile offline (classic)](power-apps/mobile/setup-mobile-offline-classic.md#step-21-add-users-or-team-to-a-mobile-offline-profile).|
