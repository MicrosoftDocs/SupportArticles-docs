...
| An error occurred from ISV code.  | [Troubleshoot Dataverse plug-ins](~/dataverse/dataverse-plug-ins-errors#error-the-given-key-wasnt-present-in-the-dictionary)|
| The plug-in execution failed. This is typically due to an error in the plug-in code. | [Troubleshoot Dataverse plug-ins](~/dataverse/dataverse-plug-ins-errors#error-the-given-key-wasnt-present-in-the-dictionary)|
