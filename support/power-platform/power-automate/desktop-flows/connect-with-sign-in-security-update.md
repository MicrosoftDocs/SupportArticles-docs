...
"Connect with sign-in" connection creation and testing will also fail with either "Invalid Credentials" or "Tenant \<tenantID> needs to be explicitly allowlisted to authorize 'connect with sign-in' runs on the machine" error.
