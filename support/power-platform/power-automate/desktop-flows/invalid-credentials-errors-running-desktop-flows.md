...
|-1073741714|User account restriction has prevented successful authentication | The referenced user name and authentication information are valid, but some user account restriction has prevented successful authentication (such as time-of-day restrictions).| Please check that there are no security or account restriction policies preventing successful login for this user|
|-1073741712|The user account is restricted such that it may not be used to log on from the source workstation | | Please check that there are no security or account restriction policies preventing a successful login for this user|
