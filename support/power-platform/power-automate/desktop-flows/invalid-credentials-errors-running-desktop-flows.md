...
|-1073741714|User account restriction has prevented successful authentication | The referenced username and authentication information are valid, but a user account restriction, such as time-of-day restrictions, has prevented successful authentications.| Confirm that no security or account restriction policies prevent his user from successfully signing in.|
