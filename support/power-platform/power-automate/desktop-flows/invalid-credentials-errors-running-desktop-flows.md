...
|-1073741714|User account restriction has prevented successful authentication | The referenced username and authentication information are valid, but a user account restriction has prevented successful authentication, such as time-of-day restrictions.| Please check that there are no security or account restriction policies preventing a successful login for this user.|
