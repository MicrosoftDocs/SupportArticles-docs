...
A possible reason you might see this issue is because of Single Sign-On Policies in your Microsoft Entra tenant. If single sign-on is enabled, your browser may prevent the currently signed in user to be logged out and instead tries to keep the user signed in.
