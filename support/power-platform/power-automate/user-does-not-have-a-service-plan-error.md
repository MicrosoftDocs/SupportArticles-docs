...
:::image type="content" source="media/user-does-not-have-a-service-plan-error/error-on-flow.png" alt-text="Screenshot of the error when doing any of these actions on a flow that uses premium connectors." border="false":::
