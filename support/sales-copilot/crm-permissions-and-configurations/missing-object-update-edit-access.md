...
description: Resolves an error that occurs when users can't update CRM records in Sales agent because of missing object access in Salesforce CRM.
ms.date: 05/12/2026
author: sbmjais
ms.author: shjais
manager: shujoshi
...
This article helps you troubleshoot and resolve issues when users can't update CRM records in Sales agent because of missing object access in Salesforce CRM.
...
When a user tries to edit an object, Sales agent checks if the user has **Write** access to the object in Salesforce. If the user doesn't have **Write** access to the object, the error message is displayed.
