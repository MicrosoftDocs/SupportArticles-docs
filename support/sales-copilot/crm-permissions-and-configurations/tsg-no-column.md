...
:::image type="content" source="media/tsg-no-column/tsg-field-error.png" alt-text="Error to delete fields.":::
...
6. Select **Set Field-Level Security** at the top.
    ...
    :::image type="content" source="media/tsg-no-column/tsg-field-error-sf.png" alt-text="Object manager in Salesforce CRM":::
...
5. Under **Manage fields**, perform one of the following actions:
    ...
    - If the issue is related to editing of a field, turn off **Allow editing** for the corresponding field.
        ...
        :::image type="content" source="media/tsg-no-column/tsg-allow-edit.png" alt-text="Turn off editing for a few fields":::

    - If the issue is related to viewing the field, hover over the field, and select **Remove field** (![Delete icon.](media/tsg-no-column/delete-icon.png "Delete icon")).
