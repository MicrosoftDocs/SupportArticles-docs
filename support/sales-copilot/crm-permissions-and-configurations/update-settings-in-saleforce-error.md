...
This article helps you troubleshoot and resolve the "Update settings in Salesforce" error that occurs in Sales agent when **Enhanced Email** isn't enabled in Salesforce CRM.
