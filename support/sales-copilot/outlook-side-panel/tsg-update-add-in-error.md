...
:::image type="content" source="media/tsg-update-add-in-error/tsg-add-in-error.png" alt-text="Add-in error":::
...
:::image type="content" source="media/tsg-update-add-in-error/tsg-add-in-warning.png" alt-text="Add-in warning on Outlook desktop app":::
...
3. In the **Add-Ins for Outlook** window, check if the **Copilot for Sales for Microsoft Outlook add-in** is listed under the **Admin-managed** section.
    ...
    :::image type="content" source="media/tsg-update-add-in-error/tsg-add-in-admin-managed.png" alt-text="Admin managed app":::
