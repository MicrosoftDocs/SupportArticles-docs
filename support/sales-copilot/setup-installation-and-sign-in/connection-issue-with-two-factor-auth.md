...
This article helps you troubleshoot and resolve an issue where the Sales agent for Microsoft Teams doesn't connect to Microsoft Dynamics 365 when the [multifactor authentication (MFA)](/microsoft-365/admin/security-and-compliance/multi-factor-authentication-microsoft-365) is enabled.
...
The Sales agent can't communicate with Dynamics 365, but users can access Dynamics 365 directly.
