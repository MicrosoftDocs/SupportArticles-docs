...
This article helps you troubleshoot and resolve error messages in Copilot for Sales when users don't have required privileges to access the organization when Administration mode is enabled.
