...
**Scenario #1:** When you try to install SQL Server 2019, SQL Server 2017, or SQL Server 2016 on a Windows 11 device, you see errors similar to the following for the Database Engine Services component of SQL Server: 
