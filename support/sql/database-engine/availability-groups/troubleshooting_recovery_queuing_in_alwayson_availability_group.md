...
1. By default, the AlwaysOn dashboard auto refreshes **Redo Queue Size (KB)** and **Redo Rate (KB/sec)** every 60 seconds.

   :::image type="content" source="media/troubleshooting-recovery-queuing-in-alwayson-availability-group/add_redo_queue_size_rate_refreshes_60.png" alt-text="Add Redo Queue Size (KB) and Redo Rate (KB/sec).":::
