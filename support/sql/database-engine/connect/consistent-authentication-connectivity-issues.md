...
|Accounts are marked as sensitive | Some accounts may be marked as sensitive in AD. These accounts can't be delegated to another service in a double-hop scenario. For more information, see [Guidance about how to configure protected accounts](/windows-server/identity/ad-ds/manage/how-to-configure-protected-accounts). |
