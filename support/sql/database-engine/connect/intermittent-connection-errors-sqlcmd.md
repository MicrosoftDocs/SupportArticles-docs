...
This article provides helps you resolve the intermittent connection errors using the command line utility SQLCMD.
...
One of the possible cause of this error is unsupported driver.
...
1. It is recommended that you upgrade the application driver to a supported driver.
...
- [Release notes for OLE DB Driver - OLE DB Driver for SQL Server](/sql/connect/oledb/release-notes-for-oledb-driver-for-sql-server?view=sql-server-ver16)
