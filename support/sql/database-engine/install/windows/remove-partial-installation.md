...
1. Navigate to the **Tools** menu and click on the installed **SQL Server features discovery report** and verify there are no more \<instance name>.INACTIVE instances shown in the report.
