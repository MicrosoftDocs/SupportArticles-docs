...
| Windows 10 | Yes (RTM) | Yes (RTM) | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Not supported | Not supported |
| Windows Server 2019 | Yes (RTM) | Yes (RTM) | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Not supported | Not supported |
| Windows Server 2016 | Yes (RTM) | Yes (RTM) | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Not supported | Not supported |
| Windows 8.1 | No | No | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Yes (SP3) | Yes (SP4) |
| Windows Server 2012 R2 | No | No | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Yes (SP3) | Yes (SP4) |
| Windows 8 | No | No | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Yes (SP3) | Yes (SP4) |
| Windows Server 2012 | No | No | Yes (RTM) | Yes (SP3) | Yes (SP3) | Yes (SP4) | Yes (SP3) | Yes (SP4) |
