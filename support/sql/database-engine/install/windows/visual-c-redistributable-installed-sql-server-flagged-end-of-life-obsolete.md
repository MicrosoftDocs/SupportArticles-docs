...
If you receive these alerts `for machines that have the listed SQL Server versions installed`, we recommend that you work with your security team to implement exclusions for those machines as appropriate. Alerts for machines that don't have the listed SQL Server versions installed should follow the guidance provided in the alert details.
