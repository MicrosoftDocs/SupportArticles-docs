...
1. Rewrite the query with the goal to simplify it:
   ...
   - Remove `TOP` (T-SQL) where possible to avoid [optimizer row goal](https://techcommunity.microsoft.com/t5/sql-server-blog/more-showplan-enhancements-8211-row-goal/ba-p/385839) resulting in nested loops.
