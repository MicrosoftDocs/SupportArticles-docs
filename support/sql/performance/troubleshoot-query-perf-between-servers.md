...
If only one query performs differently, the issue is more likely specific to the individual query rather than to the environment. In this case, go to [Step 2: Collect data and determine the type of the performance issue](#step-2-collect-data-and-determine-the-type-of-the-performance-issue).
