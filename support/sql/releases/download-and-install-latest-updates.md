...
|---|---|---|---|
|**SQL Server 2025**<br/><br/>- [Build information](#sql-server-2025)<br/>- [Installation](/sql/database-engine/install-windows/install-sql-server?view=sql-server-ver17&preserve-view=true)|None|None|[CU1 for 2025](sqlserver-2025/cumulativeupdate1.md) <br/>(17.0.4005.? TODO - January 2026)|
...
|-------------------------|--------------|-----------|-------------------------------------------------------|--------------------|
| 17.0.4005.? TODO        | None         | CU1       | [KB5074901](sqlserver-2025/cumulativeupdate1 .md)     | January 15, 2026   |
