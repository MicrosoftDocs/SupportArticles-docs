...
> [!NOTE]  
>  The version information follows the *major.minor.build.revision* pattern. The "revision" information isn't typically used when checking the version of SQL Server.
