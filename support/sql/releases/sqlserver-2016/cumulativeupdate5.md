...
|------------------------------------------|-------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
| <a id=9077598>[9077598](#9077598) </a> | 3211948 | [FIX: "Adjust height to fit zone" setting of the SSRS 2016 Report Viewer Web Part isn't respected on a SharePoint webpage](https://support.microsoft.com/help/3211948) | Reporting Services |
| <a id=9367817>[9367817](#9367817) </a> | 3212193 | [FIX: Cannot save the SSRS report after you change a parameter in Report Builder or the SQL Server Data Tool](https://support.microsoft.com/help/3212193)| Reporting Services |
| <a id=9503251>[9503251](#9503251) </a> | 4009839 | [FIX: An MDX query returns incorrect results in SSAS 2014 or 2016 Tabular mode](https://support.microsoft.com/help/4009839)| Analysis Services|
| <a id=8463442>[8463442](#8463442) </a> | 3195752 | [FIX: Wrong number of rows returned in sys.partitions for Columnstore index in SQL Server 2016](https://support.microsoft.com/help/3195752)||
| <a id=9237404>[9237404](#9237404) </a> | 3209459 | [FIX: Error 21050 when you remove a table that is not part of a publication in SQL Server 2014 or 2016](https://support.microsoft.com/help/3209459)| SQL service|
| <a id=9237351>[9237351](#9237351) </a> | 3209442 | [FIX: "No Data Available" in the SQL Server Memory Usage page in the SQL Server 2014 or 2016 MDM report](https://support.microsoft.com/help/3209442) | Management Tools |
| <a id=8532466>[8532466](#8532466) </a> | 4009794 | [FIX: Internal error 'FAC_HK_INTERNAL' when you insert or update large numbers of rows of data into or in a memory-optimized table in SQL Server 2016](https://support.microsoft.com/help/4009794) | In-Memory OLTP |
| <a id=9237398>[9237398](#9237398) </a> | 3205994 | [FIX: Memory leak when you query sys.dm_sql_referenced_entities view in SQL Server 2014 or 2016](https://support.microsoft.com/help/3205994) | SQL service|
| <a id=9367827>[9367827](#9367827) </a> | 3213240 | [FIX: Changing the data type and then updating the table with more than 4,000 records causes database corruption](https://support.microsoft.com/help/3213240)| SQL service|
| <a id=9231234>[9231234](#9231234) </a> | 3208460 | [FIX: DMV sys.dm_os_spinlock_stats returns incorrect results after you install SQL Server 2016 CU5](https://support.microsoft.com/help/3208460)| SQL service|
| <a id=9398962>[9398962](#9398962) </a> | 4013118 | [FIX: The sys.column_store_segments catalog view displays incorrect values in the column_id column in SQL Server 2016](https://support.microsoft.com/help/4013118) | SQL service|
| <a id=9237312>[9237312](#9237312) </a> | 3067968 | [FIX: Memory is paged out when columnstore index query consumes lots of memory in SQL Server 2014 or 2016](https://support.microsoft.com/help/3067968) | SQL service|
| <a id=8652609>[8652609](#8652609) </a> | 3198751 | [FIX: Out-of-memory error when you run a query to access LOB columns through In-Memory OLTP in SQL Server 2016](https://support.microsoft.com/help/3198751)| In-Memory OLTP |
| <a id=9503260>[9503260](#9503260) </a> | 4010159 | [FIX: "Invoke-sqlcmd" cmdlet executes a query statement multiple times if an error occurs in SQL Server 2014 or 2016](https://support.microsoft.com/help/4010159)| Management Tools |
| <a id=9503181>[9503181](#9503181) </a> | 3208276 | [Update improves handling of documents too large for Full-Text Search indexing in SQL Server 2014 or 2016](https://support.microsoft.com/help/3208276) | SQL service|
| <a id=9460252>[9460252](#9460252) </a> | 4013124 | [FIX: An access violation occurs when natively compiled stored procedures are executed concurrently in SQL Server 2016](https://support.microsoft.com/help/4013124)| In-Memory OLTP |
| <a id=9237340>[9237340](#9237340) </a> | 3208245 | [FIX: Incorrect query result when you use varchar(max) variable in the search condition in SQL Server 2014 or 2016](https://support.microsoft.com/help/3208245)| SQL performance|
| <a id=9367388>[9367388](#9367388) </a> | 4014719 | [FIX: "(0x80004002) No such interface supported" error when you use RMO to run Web Synchronization for Merge Replication in SQL Server 2016](https://support.microsoft.com/help/4014719) | SQL service|
| <a id=9237386>[9237386](#9237386) </a> | 3192069 | [FIX: Resize handle is missing from the parameter combo box in SQL Server 2014 or 2016 Reporting Services](https://support.microsoft.com/help/3192069) | Reporting Services |
| <a id=8930551>[8930551](#8930551) </a> | 4013877 | [Update enables DML query plan to scan query memory-optimized tables in parallel in SQL Server 2016](https://support.microsoft.com/help/4013877) | In-Memory OLTP |
| <a id=8845976>[8845976](#8845976) </a> | 3174370 | [A memory leak occurs when you use Azure Storage in SQL Server 2014 or 2016](https://support.microsoft.com/help/3174370) | SQL service|
| <a id=8497323>[8497323](#8497323) </a> | 3204469 | [FIX: Distribution Agent fails for a SQL Server 2014 publisher and a SQL Server 2012 subscriber in Transactional Replication](https://support.microsoft.com/help/3204469)| SQL service|
| <a id=9503253>[9503253](#9503253) </a> | 3212318 | [FIX: Can't set a database to partial containment if SQL Server change tracking was ever enabled on that database](https://support.microsoft.com/help/3212318) | SQL service|
| <a id=9503265>[9503265](#9503265) </a> | 4010162 | [FIX: A system assert occurs when a Transact-SQL stored procedure with a TVP argument is called from a SQLCLR procedure](https://support.microsoft.com/help/4010162) | SQL service|
| <a id=9367821>[9367821](#9367821) </a> | 3045321 | [MS15-058: Description of the security update for SQL Server 2012 Service Pack 2 GDR: July 14, 2015](https://support.microsoft.com/help/3045321) | Reporting Services |
| <a id=9237408>[9237408](#9237408) </a> | 3208524 | FIX: You cannot select any replica when you fail over from an availability group that's in the resolving state](https://support.microsoft.com/help/3208524)| High Availability|
| <a id=9503249>[9503249](#9503249) </a> | 4009823 | [FIX: AFTER DELETE triggers occur in the wrong order in the ON DELETE CASCADE action chain in SQL Server 2014 and 2016](https://support.microsoft.com/help/4009823)| SQL performance|
| <a id=9491987>[9491987](#9491987) </a> | 4014734 | [FIX: SQL Server Launchpad service fails to start if the installed version of R Services (In-Database) is different from the Database Engine in SQL Server 2016](https://support.microsoft.com/help/4014734) | SQL service|
| <a id=9237381>[9237381](#9237381) </a> | 3189959 | [FIX: Deadlock causes deferred transaction on the secondary replica in an Always On environment](https://support.microsoft.com/help/3189959) | High Availability|
| <a id=9237406>[9237406](#9237406) </a> | 3208243 | FIX: Adding a subscription to an Oracle transactional publication or an Oracle snapshot publication fails in SQL Server 2014 or 2016](https://support.microsoft.com/help/3208243)| SQL service|
| <a id=9367861>[9367861](#9367861) </a> | 3025408 | [FIX: Access violation occurs when you run and then cancel a query on distinct count partitions in SSAS](https://support.microsoft.com/help/3025408) | Analysis Services|
| <a id=9503269>[9503269](#9503269) </a> | 4010710 | [FIX: Memory leak when you run a query that you don't have sufficient permissions for in SQL Server 2014 or 2016](https://support.microsoft.com/help/4010710)| SQL security |
| <a id=9237301>[9237301](#9237301) </a> | 3030352 | [FIX: The change table is ordered incorrectly for updated rows after you enable change data capture for a Microsoft SQL Server database](https://support.microsoft.com/help/3030352) | SQL service|
| <a id=9237363>[9237363](#9237363) </a> | 3208179 | [FIX: MDX query returns errors if the value of MaxRolapOrConditions is greater than 256 in SQL Server Analysis Services](https://support.microsoft.com/help/3208179) | Analysis Services|
| <a id=9237402>[9237402](#9237402) </a> | 3207327 | [FIX: On failover, the new secondary replica stops accepting transaction log records until the instance is restarted in SQL Server](https://support.microsoft.com/help/3207327)| High Availability|
| <a id=9379517>[9379517](#9379517) </a> | 4013116 | [FIX: ALTER TABLE, ADD CONSTRAINT, and PRIMARY KEY statements do not detect a duplicate key in SQL Server 2016](https://support.microsoft.com/help/4013116)| In-Memory OLTP |
| <a id=9367384>[9367384](#9367384) </a> | 3213703 | [FIX: An Always On secondary replica goes into a disconnecting state](https://support.microsoft.com/help/3213703)| High Availability|
| <a id=9503258>[9503258](#9503258) </a> | 4010344 | [FIX: The sp_msx_enlist stored procedure fails to enlist a target server into a master server in SQL Server 2014 or 2016 if the server name is too long](https://support.microsoft.com/help/4010344) | Management Tools |
| <a id=9237345>[9237345](#9237345) </a> | 3205935 | [FIX: Error 2809 when you execute a stored procedure that takes a table-valued parameter from RPC calls in SQL Server 2014 or 2016](https://support.microsoft.com/help/3205935)| SQL performance|
| <a id=9367813>[9367813](#9367813) </a> | 3192692 | [FIX: Assert memory dump on a mirror server in SQL Server](https://support.microsoft.com/help/3192692) | High Availability|
| <a id=9371141>[9371141](#9371141) </a> | 4013112 | [FIX: "ADD PERIOD FOR SYSTEM_TIME failed" error when you add period columns to a memory-optimized table in SQL Server 2016](https://support.microsoft.com/help/4013112)||
| <a id=9368262>[9368262](#9368262) </a> | 3211304 | [FIX: Error 5262 when you execute DBCC CHECKDB on the primary replica in SQL Server 2012, 2014 or 2016](https://support.microsoft.com/help/3211304)| High Availability|
| <a id=9237316>[9237316](#9237316) </a> | 3196877 | [FIX: Incremental statistics runs with higher sample rate than regular statistics when statistics are created or updated in SQL Server 2014 or 2016](https://support.microsoft.com/help/3196877) | SQL performance|
| <a id=9237400>[9237400](#9237400) </a> | 3206299 | [FIX: Availability databases in incorrect initializing/synchronizing state after failover of SQL Server 2014 or 2016 AlwaysOn availability group](https://support.microsoft.com/help/3206299)| High Availability|
| <a id=9368267>[9368267](#9368267) </a> | 3157016 | [FIX: RDL report that's generated programmatically fails to run in SSRS](https://support.microsoft.com/help/3157016) | Reporting Services |
| <a id=9237389>[9237389](#9237389) </a> | 3204769 | [FIX: Intra-query deadlock when values are inserted into a partitioned clustered columnstore index in SQL Server 2014 or 2016](https://support.microsoft.com/help/3204769) | SQL services |
| <a id=9503271>[9503271](#9503271) </a> | 4010990 | [FIX: SQL Server is stopped when you install patches on an instance of SQL Server that contains many databases](https://support.microsoft.com/help/4010990)| Setup & Install|
| <a id=9379254>[9379254](#9379254) </a> | 4016655 | [FIX: Bad query plan created on secondary replicas after FULLSCAN statistics update on primary replica in SQL Server 2016](https://support.microsoft.com/help/4016655) | Setup & Install|
