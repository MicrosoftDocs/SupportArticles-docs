...
|---|---|---|---|---|
| <a id="11078719">[11078719](#11078719)</a> | [FIX: Bookmarks functionality does not work completely when you open a report in MHTML format through Outlook in SSRS (KB4043947)](https://support.microsoft.com/help/4043947) | Analysis Services | Reporting Services | Windows |
...
| <a id="11195748">[11195748](#11195748)</a> | [FIX: Incorrect warning message that asks to restart SQL Server when it is not required in SQL Server 2017 on Linux (KB4053447)](https://support.microsoft.com/help/4053447) | SQL Server Client Tools | Command Line Tools | Linux |
| <a id="11133452">[11133452](#11133452)</a> | [Policy-Based Management policy not working after you install CU2 for SQL Server 2016 SP1 (KB4037454)](https://support.microsoft.com/help/4037454) | SQL Server Client Tools | Policy-Based Management | All |
...
| <a id="11188014">[11188014](#11188014)</a> | [FIX: SQL Server 2017 on Linux does not listen to the nondefault IP address specified by the mssql-conf script (KB4053393)](https://support.microsoft.com/help/4053393) | SQL Server Engine | Linux | Linux |
...
| <a id="11003332">[11003332](#11003332)</a> | [FIX: ForceLastGoodPlan recommendation state is falsely reported as Expired if it is applied manually in SQL Server 2017 (KB4046102)](https://support.microsoft.com/help/4046102) | SQL Server Engine | Query Store | All |
