...
| <a id=13746930>[13746930](#13746930) </a> | `CHECKDB` reports no errors but users may see [errors 602 and 608](/sql/relational-databases/errors-events/database-engine-events-and-errors?view=sql-server-ver15#errors--2-to-999) due to inconsistent Full Text metadata.| SQL Server Engine | Storage Management| Windows|
