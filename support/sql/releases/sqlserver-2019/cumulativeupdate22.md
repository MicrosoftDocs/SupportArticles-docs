...
| <a id=2497934>[2497934](#2497934) </a> | Fixes a latch timeout issue that you might encounter in the ghost cleanup process or version cleaner when there's a long chain of Index Allocation Map (IAM) pages for a table. | SQL Server Engine| SQL Server Engine |All |
