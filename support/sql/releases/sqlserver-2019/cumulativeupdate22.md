...
| <a id=2497934>[2497934](#2497934) </a> | Fixes a latch timeout issue that you might encounter when a table has a long chain of Index Allocation Map (IAM) pages. | SQL Server Engine| SQL Server Engine |All |
...
| <a id=2126481>[2126481](#2126481) </a> | Fixes an access violation that you encounter when resuming an index rebuild that includes partitions. | SQL Server Engine| Table Index Partition | All|
