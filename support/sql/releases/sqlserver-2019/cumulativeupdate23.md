...
| <a id=2647396>[2647396](#2647396) </a> | Fixes race conditions in which certain variables aren't initialized correctly when a batch mode sort query is aborted, which causes an access violation and `INVALID_POINTER_READ_c0000005_sqlmin.dll!CBpSortLessFunctor_127,0,1,0_::OptLessFunction` exception. | SQL Server Engine| Query Optimizer | All|
