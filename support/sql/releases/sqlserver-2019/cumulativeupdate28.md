...
This article describes Cumulative Update package 28 (CU28) for Microsoft SQL Server 2019. This update contains 9 [fixes](#improvements-and-fixes-included-in-this-update) that were issued after the release of SQL Server 2019 Cumulative Update 27, and it updates components in the following builds:
...
| Bug reference| Description| Fix area| Comonent| Platform | Platform |
|----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|-------------------|----------|:--------:|
...
| <a id=3278707>[3278707](#3278707) </a> | Fixes the following error that you encounter during a Volume Shadow Copy Service (VSS) restore on a SQL Server instance that has previously deleted databases: </br></br>Volume Shadow Copy Service error: Unexpected error calling routine GetVolumePathNameis fail on the path \<PathName> ... The system cannot find the file specified.| SQL Server Engine | Backup Restore| Windows||
