...
| <a id=3539961>[3539961](#3539961) </a> | Fixes an issue in which database striped backups using virtual device interface (VDI) tools might fail to restore with [error 3456](/troubleshoot/sql/database-engine/backup-restore/backup-multistriped-vdi-issue). | SQL Server Engine| Backup Restore||
