...
| <a id="2129326">[2129326](#2129326)</a>                                                 |                 | Fixes error 8992 [Check Catalog Msg 3853, State 1: Attribute (owning_principal_id=ID) of row (principal_id=ID) in sys.database_principals does not have a matching row (principal_id=ID) in sys.database_principals.] generated by `DBCC CHECKDB` when executed against a database clone of a CDC enabled source database that has system-defined roles owned by CDC users.                                                                                                                                                                                      | SQL Server Engine           | All      |
...
| <a id="2086044">[2086044](#2086044)</a>                                                 |                 | Fixes an issue where an authenticated attacker could affect SQL Server memory when executing a specially crafted `CREATE` or `UPDATE STATISTICS` statement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | SQL Server Engine             | All      |
