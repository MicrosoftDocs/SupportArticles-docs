...
| <a id="2135970">[2135970](#2135970)</a>                                                 |                 | Fixes a `DBCC CLONEDATABASE` failure when the source database is upgraded from an earlier version of SQL Server.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | SQL Server Engine           | All      |
...
| <a id="2021487">[2021487](#2021487)</a>                                                 |                 | Fixes spelling issues in Database Engine error messages in SQL Server 2022.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | SQL Server Engine           | All      |
...
| <a id="2151109">[2151109](#2151109)</a>                                                 |                 | Fixes error 241 that occurs while running the Snapshot Agent, and the system date format was changed to a different format from that of SQL Server.</br></br>Error message:</br></br>Conversion failed when converting date and/or time from character string.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | SQL Server Engine           | All      |
...
| <a id="2087479">[2087479](#2087479)</a>                                                 |                   | After you apply this update, you need at least the control server permission to run the procedure `sys.sp_xtp_force_gc`. This update changes the implementation of the procedure to a single call to free allocated and used bytes. Before you apply this update, you need to call it twice.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | In-Memory OLTP                              |  Windows |
| <a id="2089261">[2089261](#2089261)</a></br><a id="2082644">[2082644](#2082644)</a> |                   | Fixes an issue where any member who has the DQS KB Operator (dqs_kb_operator) role or a higher privilege level role can create or overwrite arbitrary files on the machine hosting SQL Server as the account running the SQL Server service (the default account is `NT   SERVICE\MSSQLSERVER`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |  Data Quality Services (DQS)  |  Windows |
...
| <a id="2115275">[2115275](#2115275)</a>                                                 |                   | Enhances the encryption algorithm that's used to encrypt data sources and connection strings in SQL Server Analysis Services (SSAS) models.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |    Analysis Services (SSAS)   |  Windows |
...
- [Upgrade and update of availability group servers that use minimal downtime and data loss](https://msdn.microsoft.com/library/dn178483.aspx)
    ...
    > [!NOTE]
    > If you enabled Always On together with the **SSISDB** catalog, see the [information about SSIS with Always On](https://techcommunity.microsoft.com/t5/sql-server-integration-services/ssis-with-alwayson/ba-p/388091) for more information about how to apply an update in these environments.
