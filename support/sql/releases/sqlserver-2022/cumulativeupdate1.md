...
| <a id="2101033">[2101033](#2101033)</a>                                                 |                 | Updates the error message 37517 used for the Microsoft Purview access policies in SQL Server to the following:</br></br>Internal error occurred while obtaining ARC resource information from IMDS endpoint. Substate: '\%ls', status: 0x\%08x.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | SQL security                | All      |
...
| <a id="2114695">[2114695](#2114695)</a>                                                 |                 | Fixes an issue with differential backup skipping new Page Free Space (PFS) pages after a data file grows around a PFS boundary (a multiple of 8,088 pages; 64,704 KB), resulting in database corruption and a possible crash dump when this differential backup is restored.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | SQL Server Engine           | All      |
| <a id="2088539">[2088539](#2088539)</a>                                                 |                 | Adds   the queries and category of the Microsoft Customer Experience Improvement Program (CEIP) telemetry to SQL Server 2022.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | SQL security                | All      |
...
| <a id="2100518">[2100518](#2100518)</a>                                                 |                 | Fixes an issue where the Azure Active Directory (Azure AD) administrator isn't added to the sysadmin group after you configure Azure AD for SQL Server 2022.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | SQL security                | All      |
| <a id="2117119">[2117119](#2117119)</a>                                                 |                 | Removes a case of multiple inheritances in the RSA encryption code in SQL Server 2022.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | SQL   security                | All      |
...
| <a id="2159526">[2159526](#2159526)</a>                                                 |                 | Reverts the length of the `ROUTINE_DEFINITION` column to 4000 in the `INFORMATION_SCHEMA.ROUTINES` view as the previous change in the length may cause unexpected inconsistencies.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Integration Services (SSIS) | All      |
...
| <a id="2086044">[2086044](#2086044)</a>                                                 |                 | An   authenticated attacker could affect SQL Server memory when executing a specially crafted `CREATE STATISTICS` or `UPDATE STATISTICS` statement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | SQL performance             | All      |
