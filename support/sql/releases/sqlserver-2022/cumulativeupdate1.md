...
| <a   id="2114313">[2114313](#2114313)</a></br><a   id="2158583">[2158583](#2158583)</a> | 　                | Fixes   a stack overflow issue and error 40163 “instance is unavailable” caused by   queries running repeated full table scans and   updates.</br></br>**Note** This fix is a safeguarding for issues   which can cause unavailability due to memory capacity in some rare queries.   Before issuing the queries, it trys to make sure sufficient space is   available and avoids causing any further capacity issues.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 　                            | All      |
...
| <a id="1862944">[1862944](#1862944)</a>                                                 |                   | Removes the trace flag   requirement for the hybrid buffer pool with direct write feature and enables   this feature by default in SQL Server 2022. And the trace flag 898 (TF 898)   is added to disable the `Direct Write` behavior of the [hybrid   buffer   pool](https://learn.microsoft.com/sql/database-engine/configure-windows/hybrid-buffer-pool)   for troubleshooting or debugging purposes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       SQL Server Engine       |    All   |
...
| <a id="2118499">[2118499](#2118499)</a>                                                 | 5023236           | FIX: Database accessibility   issues with high-volume customer workloads that use EKM for encryption and   key generation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |          SQL Security         |  Windows |
