...
| <a id="1948145">[1948145](#1948145)</a>                                                 |                   | Fixes an error (41842: Too many   rows inserted or updated in this transaction. You can insert or update at   most 4,294,967,294 rows in memory-optimized tables in a single transaction)   that occurs when natively compiled stored procedures or in-memory transactions   don't insert many records in a single transaction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |         In-Memory OLTP        |    All   |
