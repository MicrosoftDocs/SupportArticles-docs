...
| <a id=2834436>[2834436](#2834436) </a> | Fixes an issue with database audits and Contained Availability Groups. When a database audit specification is initially created against the instance name (and not the Contained Availability Group listener) and future transactions are executed against the Contained Availability Group listener, the action may not be recorded. | SQL Server Engine | Security Infrastructure | All|
