...
| <a id=2958874>[2958874](#2958874) </a> | Fixes an issue in which the SQL Server instance fails to start on Linux kernels 6.7 or later versions.| SQL Server Engine | Linux| Linux|
