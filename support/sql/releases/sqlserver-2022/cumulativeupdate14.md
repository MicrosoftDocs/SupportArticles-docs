...
| <a id=3157066>[3157066](#3157066) </a> | Adds performance monitor counters to the cluster log report when the health check time-out is reported.| SQL Server Engine | High Availability and Disaster Recovery | Windows|
