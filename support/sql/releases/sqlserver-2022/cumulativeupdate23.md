...
| <a id=4818763>[4818763](#4818763)</a> | Fixes a bug causing memory allocation failure during VDI restore operations if memory is limited through `cgroupsv2` on Linux.                                                                                | SQL Server Engine                | Linux                                   | Linux    |
