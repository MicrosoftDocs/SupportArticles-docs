...
This article describes Cumulative Update package 24 (CU24) for Microsoft SQL Server 2022. This update contains 15 [fixes](#improvements-and-fixes-included-in-this-update) that were issued after the release of SQL Server 2022 Cumulative Update 23. It updates components in the following builds:
...
| :------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------- | :-------------------------------------- | :------- |
| <a id=4838719>[4838719](#4838719)</a> | Fixes an issue in StripedVdiTests to improve test reliability and stability.                                                                                                                                                             | SQL Server Engine | Backup Restore                          | Windows  |
...
| <a id=4911747>[4911747](#4911747)</a> | Fixes an issue in the in-memory sort buffer calculation that caused an infinite loop when the required page count exceeded supported limits.                                                                                             | SQL Server Engine | Backup Restore                          | All      |
| <a id=4917971>[4917971](#4917971)</a> | Fixes a floating point exception that occurs when switching from Hekaton to non-Hekaton stack, which causes query execution to break.                                                                                                    | Hekaton           | Query Processing                        | All      |
| <a id=4931278>[4931278](#4931278)</a> | Fixes an issue where a sort operation on a rowset larger than 4 billion rows fails with an assertion error.                                                                                                                              | SQL Server Engine | Access Methods                          | All      |
| <a id=4931830>[4931830](#4931830)</a> | Fixes an issue in which the distributor is part of an availability group (AG) and uses case-sensitive (_CS) collation. The distribution agent incorrectly uses the AG primary replica name instead of AG listener name.                  | SQL Server Engine | Replication                             | All      |
| <a id=4953763>[4953763](#4953763)</a> | Fixes an issue where the configure-only replica of a Contained Availability Group cannot be connected after a restart due to a startup failure.                                                                                          | SQL Server Engine | High Availability and Disaster Recovery | All      |
| <a id=4955136>[4955136](#4955136)</a> | Fixes an issue when using a local monitor server for Log Shipping and Contained Availability Group after failover.                                                                                                                       | SQL Server Engine | High Availability and Disaster Recovery | All      |
...
| <a id=4976761>[4976761](#4976761)</a> | Fixes an issue where altering a disabled DDL trigger caused a memory access violation.                                                                                                                                                   | SQL Server Engine | Programmability                         | All      |
| <a id=4984502>[4984502](#4984502)</a> | Adds a configurable full-text search batch timeout by using `sp_fulltext_service 'batch_timeout'`. Specify a value between 1 minute and 1 hour, in milliseconds. By default, batches time out after 10 minutes with no progress updates. | SQL Server Engine | Search                                  | All      |
...
| <a id=5011720>[5011720](#5011720)</a> | Adds a configuration option to allowlist `Bulkadmin` operations.                                                                                                                                                                         | SQL Server Engine | Linux                                   | Linux    |
