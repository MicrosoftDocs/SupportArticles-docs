...
| 5033534       | Fixes an issue in Contained Availability Group connections in which T-SQL allows only adding a database to the currently connected Contained Availability Group, with additional restrictions for DBCreator roles. | SQL Server Engine       | High Availability and Disaster Recovery | All      |
