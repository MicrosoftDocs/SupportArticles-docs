...
| <a id="2283663">[2283663](#2283663)</a> | Adds a new feature that helps parallelize the version cleaner, which will help clean up the stale versions faster on databases that have persistent version stores. | SQL Server Engine | SQL Server Engine | All |
