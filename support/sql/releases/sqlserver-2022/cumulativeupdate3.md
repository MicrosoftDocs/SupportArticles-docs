...
| <a id="2270253">[2270253](#2270253)</a> | Fixes a failure where the `DateTime` field can't be pushed down to some PolyBase generic ODBC external data sources such as Denodo when you query an external table by using a filter clause on the `DateTime` field. | SQL Server Engine | PolyBase | All |
