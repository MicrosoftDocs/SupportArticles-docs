...
| <a id="2344945">[2344945](#2344945)</a> | Fixes an issue where the SQL Server service on Linux exits with an unsuccessful code when you request to stop it. | SQL Server Engine | Query Execution | All |
