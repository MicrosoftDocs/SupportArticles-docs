...
| <a id="2329208">[2329208](#2329208)</a> | Fixes an issue when PSP with Query Store integration are enabled where PSP is unable to successfully remove a query from the in-memory representation of Query Store. | SQL Server Engine | Query Execution| All |
