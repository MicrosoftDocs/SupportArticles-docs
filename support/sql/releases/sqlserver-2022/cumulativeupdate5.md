...
| <a id="2351584">[2351584](#2351584)</a> | Fixes an issue where high PREEMPTIVE_OS_QUERYREGISTRY waits occur when you are using [Microsoft Purview DevOps policies](/purview/how-to-policies-devops-arc-sql-server). To enable this fix, you must turn on trace flag 12502, which is used to disable Purview DevOps policies for SQL Server On-Premises. | SQL Server Engine | Security Infrastructure | Windows |
