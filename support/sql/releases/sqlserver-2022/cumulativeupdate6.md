...
| <a id="2449506">[2449506](#2449506)</a> | Fixes a stopping responding issue that you encounter when calling a memory-optimized stored procedure from another memory-optimized stored procedure where the called procedure isn't yet in the plan cache, and a statistics update is triggered during query compilation. | SQL Server Engine | In-Memory OLTP | All |
