...
This article describes Cumulative Update package 9 (CU9) for Microsoft SQL Server 2022. This update contains 25 [fixes](#improvements-and-fixes-included-in-this-update) that were issued after the release of SQL Server 2022 Cumulative Update 8, and it updates components in the following builds:
...
| <a id=2654343>[2654343](#2654343) </a> | Fixes an issue in which you search for a specific node and then fail to expand the node in the hierarchy page. | Master Data Services | Master Data Services| Windows|
...
| <a id=2630696>[2630696](#2630696) </a> | Fixes an issue in which restoring a transaction log backup to the specific point in time fails with the following error: </br></br>Msg 9003, Level 20, State 9, Line \<LineNumber> </br>The log scan number (109348:456:0) passed to log scan in database 'DatabaseName' is not valid. | SQL Server Engine| Backup Restore| All|
| <a id=2557526>[2557526](#2557526) </a> | Fixes an access violation issue that occurs when removing the database snapshot files on the readable secondary replica of an Always On availability group that has the buffer pool extension enabled while running `DBCC CHECKDB`.| SQL Server Engine| DB Management | All|
...
| <a id=2499352>[2499352](#2499352) </a> | Updates the `SQDSFeedbackEEFunctors` constructor to prevent race conditions, which can cause double delete during the construction.| SQL Server Engine| Query Optimizer | All|
