...
| <a id=4845346>[4845346](#4845346)</a> | Fixes an issue where using `VECTOR` functions causes SqlLocalDB to crash.                                                                                                                                                                | SQL Server Engine | SqlLocalDB                              | Windows  |
| <a id=4852207>[4852207](#4852207)</a> | Fixes an assertion error and a dump that might occur if optimized locking and change tracking are both enabled on a database.                                                                                                            | SQL Server Engine | Storage Engine                          | All      |
| <a id=4953808>[4953808](#4953808)</a> | Fixes an issue where the configure-only replica of a Contained Availability Group cannot be connected after a restart due to startup failure without the system database.                                                                | SQL Server Engine | High Availability and Disaster Recovery | All      |
...
| <a id=4955141>[4955141](#4955141)</a> | Fixes an issue when using a local monitor server for Log Shipping and Contained Availability Group after failover.                                                                                                                       | SQL Server Engine | High Availability and Disaster Recovery | All      |
...
| <a id=5002842>[5002842](#5002842)</a> | Fixes a crash that occurs when a caller requests context that contains only control registers.                                                                                                                                           | SQLPAL            | SQLPAL                                  | Linux    |
| <a id=5004820>[5004820](#5004820)</a> | Adds a configurable full-text search batch timeout by using `sp_fulltext_service 'batch_timeout'`. Specify a value between 1 minute and 1 hour, in milliseconds. By default, batches time out after 10 minutes with no progress updates. | SQL Server Engine | Search                                  | All      |
| <a id=5004893>[5004893](#5004893)</a> | Fixes an issue where changing the SQL Server edition on Linux causes the system to use incorrect log file locations for model and msdb databases.                                                                                        | SQL Server Engine | Linux                                   | Linux    |
| <a id=5004967>[5004967](#5004967)</a> | Adds support for symbolic links in the getattribute API.                                                                                                                                                                                 | SQL Server Engine | Linux                                   | Linux    |
| <a id=5013499>[5013499](#5013499)</a> | Adds a configuration option to allowlist `Bulkadmin` operations.                                                                                                                                                                         | SQL Server Engine | Linux                                   | Linux    |
