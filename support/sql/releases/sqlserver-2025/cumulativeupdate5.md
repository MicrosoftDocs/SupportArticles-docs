...
| :------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------- | :------------------- | :------- |
| <a id=4904578>[4904578](#4904578)</a> | Adds a new [max lock manager cache memory (%)](/sql/database-engine/configure-windows/max-lock-manager-cache-memory-configuration-option) configuration setting to control the maximum size of lock manager cache memory.                                                                                                      | SQL Server Engine    | Memory Management    | All      |
