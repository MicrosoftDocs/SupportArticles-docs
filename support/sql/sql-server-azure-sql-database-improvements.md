...
description: Describes how persisted structures in your SQL Server database can be validated as part of the upgrade compatibility level, and how any affected structures can be rebuilt after you upgrade the compatibility level.
ms.date: 02/17/2020
...
> 2. Do validation to identify any impacted persisted structures.
> 3. Rebuild the structures that you identified in step 2.
...
If the **CHECKCONSTRAINTS** statement is finished and does not return a resultset, no additional action is needed.
