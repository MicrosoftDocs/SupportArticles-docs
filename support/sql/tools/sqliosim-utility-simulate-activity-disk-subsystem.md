...
- **SQLIOSim.com** is a command-line tool. You can configure it to run without user interaction. To do this, you can use command-line parameters, a configuration file, or a combination of both of these methods. 
