...
This article provides general guidelines for the Sqldumper.exe utility that is included with SQL Server. This utility to generate different kinds of dump files.
