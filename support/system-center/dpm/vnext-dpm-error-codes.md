...
|100176|This functionality is deprecated.|Use the Instant Recovery Option. This error can occur if you have upgraded to MARS agent 2.0.9266.0 or higher but are on a older version of DPM or MABS which does not support iSCSI based item level recoveries. Upgrade to the supported version of DPM or MABS documented [here](https://support.microsoft.com/en-us/topic/update-for-azure-backup-for-microsoft-azure-recovery-services-agent-b50af79f-5966-4fa4-8fd2-12b56d1e6e9a).|
