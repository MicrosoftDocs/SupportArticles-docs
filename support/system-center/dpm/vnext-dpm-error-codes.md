...
|100262|The encryption passphrase has not been validated to meet requirements. This is required to ensure successful online restores.|Please validate the encryption passphrase at the earliest by launching the PassphraseValidator.exe from ‘%ProgramFiles%\Microsoft Azure Recovery Services Agent\bin\’ folder.|
