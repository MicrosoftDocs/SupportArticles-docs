...
1. Select **Next** > **Next**.
1. Find the template.
1. Select **More information is required**.
...
1. Right click the certificate and export it with a private key to a .pfx file.
...
1. Copy the certificate to the X-Plat server where the certificate was issued.
