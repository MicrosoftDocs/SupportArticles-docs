...
1. Make sure you're using the latest version of the Remote Desktop client. By default, the client automatically updates when a new version is available. To check for updates manually, see [Update the client](/azure/virtual-desktop/users/client-features-windows?context=%2Fwindows-365%2Fcontext%2Fpr-context#update-the-client).
