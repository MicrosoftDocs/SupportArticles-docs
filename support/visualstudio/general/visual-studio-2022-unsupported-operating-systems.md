...
Visual Studio does not support application virtualization solutions such as such as Microsoft App-V for Windows or third-party app virtualization technologies.
