---
title: MFC application can't redraw control
...
This article provides the resolution to solve the issue that MFC Windows application can't redraw the resized control if the windows have a deep nested hierarchy.
