...
This article describes an issue that when using Visual Basic Scripting Edition (VBScript) to perform a numeric comparison or calculation on an `adNumeric` (131) field type, type mismatch error occurs.
