---
title: VS crashes when GetAddress() is invoked
...
This article provides resolutions about resolving the issue that Visual Studio 2010 crashes when `Microsoft.VisualStudio.Debugger.Interop.IDebugAddress.GetAddress()` is invoked.
