---
title: Configure IIS W3SVC in a WSFC
description: Describes how to configure IIS World Wide Web Publishing Service in a Windows Server failover cluster.
ms.date: 03/31/2020
...
2. Install the failover clustering feature on all cluster nodes and create the cluster. For details, see the following Microsoft Docs article:  
    [Failover Cluster Deployment Guide](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd197477(v=ws.10)).
