---
title: DataGrid displays incorrectly in pages
description: Describes an issue that data grid may not appear when you view an .aspx page that contains a DataGrid control, and provides a solution.
ms.date: 04/07/2020
ms.prod-support-area-path: 
ms.reviewer: joelrewe, anandh
---
# DataGrid control does not display correctly in .aspx page

This article provides information about resolving the issue that data grid may not appear when you view an .aspx page that contains a DataGrid control. This article refers to the Microsoft .NET Framework Class Library namespace `System.Data.SqlClient`.
