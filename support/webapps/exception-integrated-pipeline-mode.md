...
description: Describes System.Web.HttpException in Internet Information Services 7.0 and 7.5 when an application runs in Integrated Pipeline mode and resolution.
ms.date: 03/23/2020
...
This article describes the `System.Web.HttpException` in Internet Information Services (IIS) when an application runs in Integrated Pipeline mode, and provides a resolution.
...
- You run a web application configured to use the Integrated Pipeline on an IIS 7.0 or later versions web server.
