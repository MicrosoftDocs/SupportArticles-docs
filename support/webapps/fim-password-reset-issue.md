...
description: FIM 2010 password reset issue.
ms.date: 03/24/2020
ms.prod-support-area-path:
---
# Forefront Identity Manager 2010 password reset issue

This article provides information about resolving the issue that Forefront Identity Manager is unable to reset passwords on a group of user objects.
