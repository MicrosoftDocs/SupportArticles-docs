---
title: Proxy routed IIS digest authentication 
description: Provides workarounds for an issue that occurs when a client sends a request through a proxy to a site IIS using digest authentication.
ms.date: 04/07/2020
...
This article provides workarounds for an issue occurring when a client sends a request through a proxy to a site Internet Information Services (IIS) using digest authentication.
