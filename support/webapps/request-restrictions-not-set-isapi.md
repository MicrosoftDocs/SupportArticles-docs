...
description: THe Request Restrictions functionality not working for Wildcard ISAPI extension. A resolution is provided.
ms.date: 04/17/2020
ms.prod-support-area-path: 
ms.technology: iis
ms.reviewer: pphadke, wadeh, bariscag
---
# Request Restrictions cannot be set for a wildcard ISAPI in IIS 7.0 and later versions

This article provides the resolution to solve the issue that the **Request Restrictions** feature of handler mappings is not available for a Wildcard Internet Server Application Programming Interface (ISAPI) extension on Internet Information Services (IIS) 7.0 and later versions.
