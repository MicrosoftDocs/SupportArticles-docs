...
1. Verify if you're using the NVIDIA GPU:
   ...
   1. If **NVIDIA \*\*\*** appears, continue with the next steps. If not, no update is needed for this Cloud PC.

1. Download and install the latest driver:
   ...
   1. Download the latest driver for your Windows operating system.
   1. Extract the files and run the installer (no need to uninstall your current driver).
   1. Restart your Cloud PC once the installation is complete.

1. Verify that the update is successful:

   1. After restarting, open **Device Manager** again.
   1. Expand **Display Adapters** and confirm that the error has disappeared.
