...
After you AI-enable your Cloud PC, background processes might run for 24 – 48 hours before supported AI features are ready to use.
...
You can still use Click‑to‑Do by manually launching it from the Start menu. Select Start, search for Click‑to‑Do,
and open the app from the search results.
...
If you're experiencing issues that aren't covered in this article, you can contact Microsoft Support by 
submitting a support request through the Microsoft 365 admin center.
[Get support – Microsoft 365 admin](https://learn.microsoft.com/en-us/microsoft-365/admin/get-help-support?view=o365-worldwide)
