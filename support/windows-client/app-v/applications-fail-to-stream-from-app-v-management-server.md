...
_Original product version:_ &nbsp; Microsoft Application Virtualization 4.5 for Terminal Services, Application Virtualization 4.5 for Windows Desktops, App-V 4.6 for Remote Desktop Services, Microsoft Application Virtualization 4.6 for Remote Desktop Services Service Pack 1, Microsoft Application Virtualization 4.6 for Windows Desktops, Microsoft Application Virtualization 4.6 for Windows Desktops Service Pack 1, Microsoft Application Virtualization for Remote Desktop Services, Application Virtualization for Windows Desktops, Microsoft Application Virtualization Hosting 4.6 for Windows Desktops, Microsoft Application Virtualization Hosting 4.6 for Windows Desktops Service Pack 1  
...
Note: If the application OSD file is using the %SFT_SOFTGRIDSERVER% environment variable for the server name, verify the environment variable is configured on the App-V Client by performing the steps documented in the following Microsoft knowledge base article:
 [https://support.microsoft.com/kb/2271342](https://support.microsoft.com/help/2271342) 
...
Microsoft Showcase video which covers how to fix common App-V configuration issues: [https://www.microsoft.com/showcase/en/us/details/b2e8800e-e84f-4d98-aaec-68f1af00ab08](https://www.microsoft.com/showcase/en/us/details/b2e8800e-e84f-4d98-aaec-68f1af00ab08) 

App-V TechCenter on TechNet: [https://technet.microsoft.com/appvirtualization/default.aspx](https://technet.microsoft.com/appvirtualization/default.aspx) 

Common error codes when an application fails to stream: 44-00001004 0a-00000193 0a-10000001 0a-0000e02b 0a-200001f4 64-00000003 2A-80090322 08-10000003 0a-0000E005 0A-0000E0A3 0A-40000191 2A-0000274D 0A-20000194 2A-00002AF9 0A-10000002
