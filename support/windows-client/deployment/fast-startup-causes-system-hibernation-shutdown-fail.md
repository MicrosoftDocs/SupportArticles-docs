---
title: Fast startup causes hibernation or shutdown to fail
...
When you go to the **Details** tab in the event and then select friendly view, you may notice the following:
...
When you restart the computer, this typically means that you want a new Windows state, either because you have installed a driver or replaced Windows elements that cannot be replaced without a full restart.
