---
title: Windows 10 upgrade log files
...
2. Based on the [extend code](/windows-10-upgrade-error-codes.md#extend-codes) portion of the error code, determine the type and location of a [log files](#log-files) to investigate.
