...
2. Install the most recent Servicing Stack Update that matches your version of Windows from the Microsoft Update Catalog. For more information on servicing stack updates, see [Servicing stack updates](servicing-stack-updates.md).
...
Advanced users can also refer to the [log](windows-update-log-files.md) generated by Windows Update for further investigation.  
