...
In the above cases, users programatically calling into the Windows Update Agent API to [retreive the result](https://learn.microsoft.com/windows/win32/api/wuapi/nf-wuapi-isearchresult-get_resultcode) of a search operation would get [orcFailed](https://learn.microsoft.com/windows/win32/api/wuapi/ne-wuapi-operationresultcode) or [orcSucceededWithErrors](https://learn.microsoft.com/windows/win32/api/wuapi/ne-wuapi-operationresultcode). Retrying the operation at a later time is expected to succeed.