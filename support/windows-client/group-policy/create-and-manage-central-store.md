...
Supported client operating systems (from Windows 8.1 and onwards) do not include Administrative Templates that have an .adm extension. We recommend that you use computers that are running Windows 8.1 or later versions of Windows to perform Group Policy administration.
