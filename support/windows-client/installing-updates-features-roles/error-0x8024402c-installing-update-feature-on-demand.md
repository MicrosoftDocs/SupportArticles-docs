...
> [!NOTE]  
> If you want to install OpenSSH Server or OpenSSH Client as Features on Demand, see [Can't install OpenSSH features](../../windows-server/system-management-components/cant-install-openssh-features.md).
