...
- **For any supported version of Windows:** Open an administrative command prompt window, and then run the following command:
  [Supported Windows versions](https://learn.microsoft.com/en-us/windows/release-health/supported-versions-windows-client) 
  ```cmd
...
For more information, see [Latest Servicing Stack Updates](https://msrc.microsoft.com/update-guide/vulnerability/ADV990001) or look for the latest Servicing Stack required for Latest Cumulative Update on the Update History for your Windows version.
...
## OR
1. Use the location you saved the update file to, for this example: C:\temp.
2. Open an elevated command prompt
3. Execute command: 
  ```cmd
  Dism /online /add-package /packagepath:C:\temp\<KB file name>.msu 
  ```
This should skip Windows Update agent applicability checks and can make the installation go further and/or quicker. 
...
Read the package's related article to find out if the prerequisite updates are installed. For example, if you receive the error message in Windows 10 22H2 July's update KB5040525, you might have to install KB50282445, KB5031539 or more prerequisite servicing updates.
...
- [Windows 11 Update history](https://support.microsoft.com/en-us/topic/july-25-2024-kb5040527-os-builds-22621-3958-and-22631-3958-preview-de3e1e24-0c07-4210-9777-8e03a1446bae)
