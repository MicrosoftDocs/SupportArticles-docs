...
Note for Symptom 1 and for Symptom 2 

These symptoms occur on policies that are created and that are populated by using the Local Group Policy Editor on a computer that is running Windows Server 2003, Windows Server 2008, or a version of Windows that is newer than Windows Server 2008.
...
[General information about the Folder Redirection feature](https://technet.microsoft.com/library/cc732275%28ws.10%29.aspx)
