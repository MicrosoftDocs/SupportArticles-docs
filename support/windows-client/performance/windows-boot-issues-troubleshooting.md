...
old_title: Advanced troubleshooting for Windows boot problems
old_ms.prod: w10
...
:::image type="content" source="media/windows-boot-issues-troubleshooting/boot-sequence-thumb.png" alt-text="Diagram of the boot sequence flowchart." border="false":::
