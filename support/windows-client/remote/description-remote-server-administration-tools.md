...
|Storage Manager for Storage Area Networks (SANs) Tools|Storage Manager for SANs Tools include:<ul><li>The Storage Manager for SANs snap-in</li><li>The Provisionstorage.exe command-line tool</li></ul>| √ <br/><br/>Storage Manager for SANs is available in Windows Server 2003 R2 and later versions.| √ |
