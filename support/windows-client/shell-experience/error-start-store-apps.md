...
:::image type="content" source="media/error-start-store-apps/error-screenshot.png" alt-text="Screenshot of the Microsoft Store apps error message." border="false":::
