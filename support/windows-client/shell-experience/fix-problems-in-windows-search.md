...
If Windows Search is unresponsive or the search results don't appear as expected, try any of the following solutions that provided in this article.
...
If the Windows 10 October 2018 Update or an earlier update is installed, reset Cortana to reset Windows Search. To do this, follow these steps:
