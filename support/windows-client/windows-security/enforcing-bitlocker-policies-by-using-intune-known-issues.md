...
![Screenshot of Windows image configuration in Microsoft Configuration Manager.](media/enforcing-bitlocker-policies-by-using-intune-known-issues/config-mgr-image-config.png)
