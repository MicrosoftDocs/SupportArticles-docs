...
| - | - | - | - |
| **State 1** | The object doesn't exist. | The object exists on all DCs. | The object exists on all DCs. |
| **State 2** | The object doesn't exist. | The object exists on all DCs. | The object exists on all DCs.<br/>One DC (DC-1) disconnects from the network. |
| **State 3** | The object doesn't exist. | The object is deleted. The "delete" change replicates to all DCs. | The object is deleted. The "delete" change replicates to all DCs except DC-1. |
