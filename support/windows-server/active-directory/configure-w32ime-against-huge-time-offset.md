...
The default value of these two registry entries is 2a300 (hexadecimal) or 172800 (decimal). This default value means "Accept time changes within the 48-hour range." We recommend that you set the value of the MaxPollInterval registry entry to 10 or less or that you set the value of the SpecialPollInterval registry entry to 3600 (1 hour) or less.
