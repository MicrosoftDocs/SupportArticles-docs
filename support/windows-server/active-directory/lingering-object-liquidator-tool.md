![image](https://github.com/user-attachments/assets/6411aeb0-b032-4ef3-aa07-c1fbaab1196a)---
...
<img width="778" alt="LOL" src="https://github.com/user-attachments/assets/0cf431d6-e646-4a4a-b352-86e9e637f505">
...
2. The following are the fields on the Lingering Objects tab:
   ...
   <img width="221" alt="image" src="https://github.com/user-attachments/assets/76e4d473-7631-490e-82eb-f20a10488cac">
   ...
   <img width="220" alt="ReferenceDC" src="https://github.com/user-attachments/assets/b31427a9-8b7d-4576-8fba-a3e8e32c6412">
   ...
   <img width="221" alt="Target" src="https://github.com/user-attachments/assets/671a3be4-d1be-4141-8902-64cc694b0ab1">

3. Click "Detect Lingering Object" to use the selected DCs for the comparison or select "scan entire forest" and "target all DCs" to scan entire enviroment.
   ...
   <img width="760" alt="LOLScan" src="https://github.com/user-attachments/assets/acabb159-90a1-40f1-8a6d-abcfc5a0c732">
   ...
   <img width="757" alt="LOLReport" src="https://github.com/user-attachments/assets/e43bd7e7-e5d7-413c-b5b0-edc414abb813">
   ...
   <img width="757" alt="LOLReport" src="https://github.com/user-attachments/assets/80da951e-b4dc-427e-ade9-3ae5686de91d">
...
5. Removal Methods
   ...
   There are two supported methods to remove the detected lingering objects. The "removeLingeringObject" method refers to the rootDSE modify operation , which can be used to remove individual lingering objects. "DsReplicaVerifyObjects" method will select all lingering objects all at once.
   ...
   <img width="757" alt="LOSelection" src="https://github.com/user-attachments/assets/ffba6b65-fd02-4bf4-98ec-248de3f97bb4">
   ...
   <img width="757" alt="image" src="https://github.com/user-attachments/assets/b29203e4-a679-4078-93f7-cf5a6c197b66">
