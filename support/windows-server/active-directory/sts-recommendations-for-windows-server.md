...
This part of the note is included for completeness only. There are no current trends of this scenario occurring on non-Windows Server OS SKUs and there's no current general guidance to disabling STS in non- Windows Server OS SKUs.
