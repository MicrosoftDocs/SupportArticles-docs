...
---
# 0x80004027 error when you try to remotely access COM+ object after you upgrade to Windows Server 2016 or later

This article provides a solution to the 0x80004027-CO_E_CLASS_DISABLED error that occurs when you remotely access COM+ object after you upgrade to Windows Server 2016 or later.
...
After you upgrade from an earlier release of Windows Server to Windows Server 2016 or later, applications cannot remotely access a COM+ object, and you receive the following error message:

> 0x80004027-CO_E_CLASS_DISABLED

## Cause

This problem occurs because support for the Application Server role was removed from Windows Server 2016 or later. This change blocks applications that rely on COM+ remote access.
