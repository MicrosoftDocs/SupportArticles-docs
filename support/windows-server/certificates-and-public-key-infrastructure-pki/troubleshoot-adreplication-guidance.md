...
A domain controller has failed inbound replication with the named source domain controller long enough for a deletion to have been tombstoned, replicated, and garbage-collected from AD DS. See [Active Directory replication Event ID 2042](../active-directory/active-directory-replication-event-id-2042.md).
...
If no items appear in the "Inbound Neighbors" section of the output that is generated by `repadmin /showrepl`, the domain controller wasn't able to establish replication links with another domain controller. See [Active Directory replication Event ID 1925](../active-directory/active-directory-replication-event-id-1925-dns-lookup.md).
...
A replication link exists between two domain controllers, but replication can’t be done correctly because of an authentication failure. See [Active Directory replication fails with error 5: Access is denied](../active-directory/replications-fail-with-error-5.md).
...
- [Active Directory replication Event ID 1925](../active-directory/active-directory-replication-event-id-1925-dns-lookup.md)
- [Active Directory replication Event ID 2087](../active-directory/active-directory-replication-event-id-2087.md)
...
- [Troubleshoot common Active Directory replication errors](../active-directory/common-active-directory-replication-errors.md)
