...
- Riprep images
- Existing Windows installations For more information about how to add OEM supplied mass-storage devices during text-mode Setup, click the following article number to view the article in the Microsoft Knowledge Base:

[220845](https://support.microsoft.com/help/220845) Adding third-party or updated driver during Windows Setup  
...
When you add drivers to unattended Setup, follow these steps. If the OEM-supplied drivers are not digitally signed, you may receive a message about the drivers during Setup. For more information about how to disable this message, click the following article number to view the article in the Microsoft Knowledge Base:

[236029](https://support.microsoft.com/help/236029) How to set the driver signing policy for Windows 2000 Unattended Setup  
...
[253340](https://support.microsoft.com/help/253340) Non-present SCSI devices appear in Device Manager when you are using Sysprep version 1.1  

[216937](https://support.microsoft.com/help/216937) Windows 2000 System Preparation tool and Answer File usage  
...
[256204](https://support.microsoft.com/help/256204) Unsigned drivers not installed during Sysprep Mini-Wizard without "-pnp" switch  
...
2. Modify the RIS image default template (Ristndrd.sif). In the [Unattended] section, change the OemPreinstall = key value from No to Yes, and then add the OemPnPDriversPath = Driver_Path entries. You can list multiple paths in this key by separating them with a semicolon (;) as shown in the following example.
    ...
    > [!NOTE]
    > If one of the OEM-supplied drivers is for a network adapter device, the RIS server must have this file available when it restarts in text-mode Setup. For more information about this process, click the following article number to view the article in the Microsoft Knowledge Base:

    [246184](https://support.microsoft.com/help/246184) How to add third-party OEM network adapters to RIS installations  
...
[258862](https://support.microsoft.com/help/258862) Riprep.exe adds duplicate paths to the registry  
...
[892778](https://support.microsoft.com/help/892778) Updated System Preparation tool for Windows Server 2003 Service Pack 1  
