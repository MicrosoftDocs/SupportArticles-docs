...
|November 24, 2012| [2786667](https://support.microsoft.com/help/2786667)|Validate simultaneous failover test fails when you run cluster validation tests on a multi-node failover cluster that is running Windows Server 2008 R2 SP1|Clusdisk.sys|Prevents validation failure to make sure that configuration is fully supported.|
