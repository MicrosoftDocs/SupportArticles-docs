...
- The ADMT agent, which is installed by ADMT on computers in the source domains, can operate on computers that are running Windows 2000 Professional, Windows 2000 Server, Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7, or Windows Server 2008 R2. For more information about this issue, click the following article number to view the article in the Microsoft Knowledge Base:

[974625](https://support.microsoft.com/help/974625) You cannot uninstall ADMT 3.1 after you perform an in-place upgrade to Windows Server 2008 R2  
