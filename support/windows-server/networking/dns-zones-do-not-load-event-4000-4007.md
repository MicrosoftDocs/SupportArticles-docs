...
This article solves an issue that event ID 4000 and 4007 are logged when the DNS zones aren't loaded on the DNS console.
...
One of the DNS servers in your environment starts showing an issue that the zones aren't loaded on the DNS console. And Event ID 4000 and 4007 are logged in the DNS event logs:
