...
Note: If this error message is in the eventlog of all the members of a particular replica set, then perform steps (4-a) and (4-e) above on only
one of the members.
...
until the sharing violations are eliminated. For more information on troubleshooting, refer to [https://support.microsoft.com/?id=822300](https://support.microsoft.com/?id=822300).
