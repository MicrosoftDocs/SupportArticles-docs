...
Configure your third party SMB server device to require a user name and password for SMB connections. A device allows guest access means any device or person on your network can read or copy all of your shared data without any audit trail or credentials.
