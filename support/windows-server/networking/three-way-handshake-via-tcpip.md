...
This article discusses the process of the Transmission Control Protocol (TCP) three-way handshake that occurs between a client and server when starting or ending a TCP connection.
