...
During the post-installation phase of the DHCP role on a server, you may encounter an error message that resembles the following:
...
6. In the **Auditing** tab, click **Add**.
