...
This problem occurs because of the desktop heap limitation. When you close some windows, and then try to open other windows, these windows may open. However, this method doesn't affect the desktop heap limitation. Session 0 is a special session and when desktop heap exhaustion occurs in session 0, it can lead to undesired and unexpected behaviors across the entire system.
