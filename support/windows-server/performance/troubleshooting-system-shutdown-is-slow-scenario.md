...
For an overview of the tools and how to use them, see [Troubleshoot processes and threads by using WPR and WPA](/windows-server/support-tools/support-tools-xperf-wpa-wpr).
...
WPA loads thumbnails of the various categories of recorded data in the Graph Explorer. To analyze the data, select a category to expand it and then drag a thumnail to the **Analysis** tab. For more information about how to use WPA, see [Troubleshoot processes and threads by using WPR and WPA: Using WPA to analyze data](/windows-server/support-tools/support-tools-xperf-wpa-wpr#using-wpa-to-analyze-data).
