...
When you try to log on to a Microsoft Windows Server 2003-based terminal server, you receive the following error message: Windows cannot load the user's profile but has logged you on with the default profile for the system.
