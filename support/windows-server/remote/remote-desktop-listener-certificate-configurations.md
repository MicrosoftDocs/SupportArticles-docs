...
2. Scroll down to the **Thumbprint** field and copy it. The following screenshot is an example of the certificate thumbprint in the **Certificate** properties:
   ...
   :::image type="content" source="./media/remote-desktop-listener-certificate-configurations/thumbprint-property-windows11" alt-text="An example of the certificate thumbprint in the Certificate properties.":::
