---
title: Can't import a virtual machine
description: Fixes an issue that you may receive a 0x80070057 error message when you import a virtual machine on a Hyper-V server.
ms.date: 09/14/2020
author: Deland-Han 
ms.author: delhan
manager: dscontentpm
