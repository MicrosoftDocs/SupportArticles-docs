...
To resolve this problem, configure the real-time scanning component in your antivirus software to exclude the directories, processes, and files according to the [Recommended antivirus exclusions for Hyper-V hosts]()  article.
