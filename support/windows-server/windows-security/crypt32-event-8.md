...
- An application has been installed that has been designed to interact with the Windows Security app (WSC) on Windows Vista or higher. Example applications include third-party virus software, malware scanners, or firewall products.
