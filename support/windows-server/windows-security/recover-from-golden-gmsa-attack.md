...
> - An authoritative restore rolls back all attributes to the rime of backup, including the accounts that are allowed to retrieve the gMSA credentials (PrincipalsAllowedToRetrieveManagedPassword).
