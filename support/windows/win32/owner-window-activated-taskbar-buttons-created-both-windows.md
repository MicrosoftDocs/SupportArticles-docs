...
To solve the issue, use one of the following methods:
...
- Method2:
    ...
    Create a single taskbar button for windows in a window ownership group, which includes the top-level window and any owned windows. When users select the taskbar button, the system will activate the correct window in the ownership group.
