---
title: Send data segment over TCP with Winsock
description: Provides a series of recommendations for sending small data packets efficiently from a Winsock application.
ms.date: 02/27/2020
